...
def build():
    ...
    return {
        ...
        "question": "Does the actual normalized shift-invariant n=3 characteristic projector used by the completed q8--q10 packet calculation evade the public finite-regulator Eq. (19) charge--squeeze obstruction, and if not is there an exact parity-completed enlarged carrier?",
