...
**Rail** Forge, `tango/forge/examples/curvature_symbolic_family_gate.forge` — 18/18 (15/15 when this
...
increase. The gate is now 18/18; the added check belongs to a different result and is not
