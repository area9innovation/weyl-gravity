...
**Rail** Forge, `tango/forge/examples/curvature_euler_gate.forge` — 14/14, TSan clean
...
forge verify examples/curvature_euler_gate.forge                  # 14/14, ~9 min on six workers
