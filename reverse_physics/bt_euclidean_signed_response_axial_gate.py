...
def build() -> dict:
    ...
    return {
        ...
        "conditional_response": {
            ...
            "axial_distance_two": "D_(o+2e) M_o=-(t_(o+e,o)*t_(o+e,o+2e)/lambda^2)*Cov_q(z,exp(z))<0",
            "mixed_distance_two": "D_(o+e+f) M_o is the negative sum of the two positive path products times Cov_q(z,exp(z))/lambda^2",
        },
