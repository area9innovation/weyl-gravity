...
CERTS = {
    ...
    "BH2AR": PKG / "certificates" / "BH2A_COMPOSED_REPAIR.json",
}
...
def entries():
    ...
    E.append({
        ...
        "evidence": _evidence("BH2BP", "BH2BR", "BH2BC", "BH2BD", "BH2Z", "BH2CJ", "BH2CM", "BH2CF", "BH2CP", "BHCT", "BH2AR"),
