...
PREDECESSOR = ROOT / (
    ...
    "axial_qnm_child_grid_boundary_chunk_v8"
)
...
def _build_raw() -> dict:
    ...
    return {
        "schema": "phase3-axial-qnm-child-grid-boundary-raw-run-v9",
...
def _build_aggregate(raw: dict, predecessor: dict) -> dict:
        ...
        segments.append(
            {
                ...
                "source": "qnm-child-grid-boundary-chunk-v9",
    ...
    return {
        "schema": "phase3-axial-qnm-child-grid-boundary-aggregate-run-v9",
...
def main() -> None:
    ...
    certificate = {
        "schema": "phase3-axial-qnm-child-grid-boundary-chunk-v9",
    ...
    REPORT.write_text(
        "# Fixed child-grid projective Evans continuation v9\n\n"
    ...
    commands = [
        ...
        [
            ...
            (
                "black_hole_programme.phase3."
                "axial_qnm_child_grid_boundary_chunk_v9.verify"
            ),
        ],
        [
            "python3",
            ...
            (
                "black_hole_programme.phase3."
                "axial_qnm_child_grid_boundary_chunk_v9.test_v9"
            ),
        ],
    ]
    checks = []
    ...
    RECEIPT.write_text(
        json.dumps(
            {
                "schema": "phase3-axial-qnm-child-grid-boundary-receipt-v9",
