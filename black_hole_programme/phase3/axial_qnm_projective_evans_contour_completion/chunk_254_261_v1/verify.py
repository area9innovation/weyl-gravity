#!/usr/bin/env python3
"""Verify the 254--261 continuation without rerunning its transport panels."""
...
def main() -> None:
    ...
    assert raw["requested_child_range"] == [254, 261]
    ...
    print(
        "Evans contour chunk 254--261 verifier: PASS "
