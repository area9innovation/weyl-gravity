#!/usr/bin/env python3
"""Produce the panels 48--63 common-affine certificate."""
...
PREDECESSOR = ROOT / (
    ...
    "axial_qnm_common_affine_evans_chunk_v3/certificate.json"
)
BASE_SOURCE = ROOT / (
    "black_hole_programme/phase3/"
...
def main() -> None:
    ...
    certificate = {
        "schema": "phase3-axial-qnm-common-affine-evans-chunk-v4",
        "status": (
            "PANELS_48_THROUGH_63_BOUNDARY_NONVANISHING_CERTIFIED"
            if complete else "CHUNK_48_THROUGH_63_FAIL_CLOSED"
        ),
    ...
    REPORT.write_text(
        "# Common-affine projective Evans chunk v4\n\n"
        "Dependency tags: `LOCAL-ALGEBRAIC`, `REDUCED-MODE`.\n\n"
        f"Requested panels 48--63; complete=`{complete}`, terminal="
    ...
    commands = [
        ...
        ["python3", "-m", "unittest", "-v",
         "black_hole_programme.phase3."
         "axial_qnm_common_affine_evans_chunk_v4.test_chunk"],
        ["python3", "-m",
         "black_hole_programme.phase3."
         "axial_qnm_common_affine_evans_chunk_v4.verify"],
    ]
    checks = []
    ...
    RECEIPT.write_text(json.dumps({
        "schema": (
            "phase3-axial-qnm-common-affine-evans-chunk-receipt-v4"
        ),
