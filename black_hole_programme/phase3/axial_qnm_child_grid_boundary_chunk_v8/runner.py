...
PREDECESSOR = ROOT / (
    ...
    "axial_qnm_adaptive_dyadic_boundary_chunk_v7b"
)
...
def _build_raw() -> dict:
    ...
    return {
        "schema": "phase3-axial-qnm-child-grid-boundary-raw-run-v8",
...
def _build_aggregate(raw: dict, predecessor: dict) -> dict:
        ...
        segments.append(
            {
                ...
                "source": "qnm-child-grid-boundary-chunk-v8",
    ...
    return {
        "schema": "phase3-axial-qnm-child-grid-boundary-aggregate-run-v8",
...
def main() -> None:
    ...
    certificate = {
        "schema": "phase3-axial-qnm-child-grid-boundary-chunk-v8",
        ...
        "method": {
            ...
            "performance_disposition": (
                "The 32-panel affected-chain producer may exceed 60 seconds; "
                "the replayless verifier is the per-commit Tier 1 rail. "
                "Future transport chunks must be smaller."
            ),
    ...
    REPORT.write_text(
        "# Fixed child-grid projective Evans continuation v8\n\n"
    ...
    commands = [
        ...
        [
            ...
            (
                "black_hole_programme.phase3."
                "axial_qnm_child_grid_boundary_chunk_v8.verify"
            ),
        ],
        [
            "python3",
            ...
            (
                "black_hole_programme.phase3."
                "axial_qnm_child_grid_boundary_chunk_v8.test_v8"
            ),
        ],
    ]
    checks = []
    ...
    RECEIPT.write_text(
        json.dumps(
            {
                "schema": "phase3-axial-qnm-child-grid-boundary-receipt-v8",
                ...
                "higher_tiers_not_run": (
                    ...
                    "release. The 32-panel transport is the affected "
