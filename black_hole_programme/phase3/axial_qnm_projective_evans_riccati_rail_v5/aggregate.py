#!/usr/bin/env python3
"""Aggregate the contiguous certified projective prefix through panel 47."""
...
V4 = ROOT / (
    "black_hole_programme/phase3/"
    "axial_qnm_projective_evans_riccati_rail_v4/certificate.json"
)
...
def compute() -> dict:
    ...
    full = 512
    return {
        "schema": "phase3-axial-qnm-projective-evans-riccati-run-v5",
        "arithmetic": "python-flint acb/arb, 128 bits",
        "status": "PANELS_0_THROUGH_47_AGGREGATED_LOCAL_QNM_GATE_FAIL_CLOSED",
        "rows": rows,
        "summary": {
