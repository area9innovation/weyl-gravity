#!/usr/bin/env python3
"""Run scoped checks and write the chunk-02 receipt."""
...
MODULE = (
    ...
    "axial_partial_jet_outgoing_bplus4_chunk02_v1"
)
...
def main() -> int:
    commands = [
        ...
        run(["python3", "-m", "unittest", f"{MODULE}.test_chunk02"]),
        run(
            [
                "python3",
                "-m",
    ...
    receipt = {
        "schema": (
            "phase3-axial-partial-jet-outgoing-bplus4-chunk02-receipt-v1"
        ),
        ...
        "test_tiers": {
            ...
            "tier_2_affected_chain": (
                "NOT_RUN: predecessor and operator imports are unchanged and "
                "content-addressed; this chunk ran its direct boundary gate"
            ),
            "tier_3_full_suite": (
        ...
        "commands": commands,
        "claim_boundary": (
            "One larger 5/32 content-addressed successor from r=123/4 to "
            "r=979/32 completes in 38.2 seconds and passes its direct "
