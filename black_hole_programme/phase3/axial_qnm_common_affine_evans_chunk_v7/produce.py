#!/usr/bin/env python3
"""Produce the stable-root panels 94--109 common-affine certificate."""
...
def main() -> None:
    ...
    certificate = {
        "schema": "phase3-axial-qnm-common-affine-evans-chunk-v7",
        "status": (
            "PANELS_94_THROUGH_109_BOUNDARY_NONVANISHING_CERTIFIED"
            if complete else "CHUNK_94_THROUGH_109_FAIL_CLOSED"
        ),
    ...
    REPORT.write_text(
        "# Stable-root common-affine Evans chunk v7\n\n"
        "Dependency tags: `LOCAL-ALGEBRAIC`, `REDUCED-MODE`.\n\n"
        f"Requested panels 94--109; complete=`{complete}`, terminal="
    ...
    commands = [
        ...
        ["python3", "-m", "unittest", "-v",
         "black_hole_programme.phase3."
         "axial_qnm_common_affine_evans_chunk_v7.test_chunk"],
        ["python3", "-m",
         "black_hole_programme.phase3."
         "axial_qnm_common_affine_evans_chunk_v7.verify"],
    ]
    checks = []
    ...
    RECEIPT.write_text(json.dumps({
        "schema": (
            "phase3-axial-qnm-common-affine-evans-chunk-receipt-v7"
        ),
