...
def main() -> None:
    ...
    print(
        ...
        "E/A/L spectrum. Nine independent bridge obligations remain, including "
        "the complete all-row prolongation, prolonged BV witness and "
        "Green homotopy, endpoint recovery, SO(4,2)-equivariant transport, and "
        "prolonged-current comparison. A direct same-bundle metric factorization, "
