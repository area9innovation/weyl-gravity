...
def main() -> None:
    ...
    print(
        ...
        "theorem fail-closed. The selected curvature route now has exact curved "
        ...
        "off-shell prolonged-current comparison are exact. Six causal/transport "
        "obligations remain: the prolonged Green witness and causal Green "
        "operators, the Green homotopy and causal quasi-isomorphism, endpoint "
        "recovery, and SO(4,2)-equivariant transport. A direct same-bundle metric factorization, "
        "complete covariant/Cauchy Green pairing comparison, "
