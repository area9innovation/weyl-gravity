...
def verify() -> None:
    ...
    assert records["mixed_bounded_witness"]["classification"]["candidate_13_mixed_witness_bounded_second_order_extendible"]
    ...
    assert flags["five_stabilizer_and_eighteen_resonance_functionals_necessary_and_sufficient_bounded"]
