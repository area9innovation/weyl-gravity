...
def build_certificate() -> dict[str, Any]:
    ...
    return {
        ...
        "interpretation": "Every ordinary axial Einstein-Maxwell wave with ell>=2 remains nonnull in the literal Weyl-Maxwell presymplectic restriction, but the plus and minus master branches carry exact relative weights 1+(3/2)*sqrt(2*lambda) and 1-(3/2)*sqrt(2*lambda). Their opposite signs persist for every ell>=2. Thus the linear tangent inclusion lands in a target subspace on which the restricted Weyl-Maxwell form is nondegenerate but indefinite. It is not a symplectic embedding of the Einstein-Maxwell form and not a positive or universally rescaled copy of the Einstein-Maxwell phase space.",
