...
def build()->dict[str,Any]:
 ...
 "verification_receipt":{"producing_date":"2026-07-19","tier_0":{"status":"PENDING"},"tier_1":{"status":"PENDING","tests_run":0},"tier_2":{"status":"PENDING","criterion":"eight direct four-dimensional position-source columns with the corrected ell2 axial projector"},"tier_3":{"status":"NOT_RUN","reason":"other ell, momentum and higher lifecycles remain fail-closed"}},
