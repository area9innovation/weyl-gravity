...
#
# Twelve developments, all zero-axiom, in dependency order.  The first four are the
...
neg_ok=0
for n in _neg_a _neg_b _neg_c _neg_d _neg_e _neg_f _neg_g _neg_h _neg_i _neg_j _neg_k _neg_l; do
...
rm -f _neg_[a-l].v _neg_[a-l].vo _neg_[a-l].vok _neg_[a-l].vos _neg_[a-l].glob ._neg_[a-l].aux
