...
| Schwarzschild black holes | The axial programme contains exact factorization and endpoint results and a validated defective axial \(\ell=2\) resonance. Global retarded waveform completeness and the full polar problem remain open. | [Papers 14, 16–18](paper/) |
...
| [18](paper/18-static-bach-flat-black-hole-thermodynamics.pdf) | Residual-basic thermodynamics of static Bach-flat black holes |
