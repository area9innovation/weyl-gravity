...
class BergerSupportLocalCoupledMaxwellQ2Test(unittest.TestCase):
    ...
    def test_complete_export_and_persisted_outputs(self):
        ...
        self.assertEqual(self.certificate["classical_binary_q2"]["overlay_term_count"], 1890)
        self.assertEqual(self.certificate["classical_binary_q2"]["combined_term_count"], 152195)
