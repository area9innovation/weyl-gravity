...
def test_maxwell_contraction_and_transfer_scope() -> None:
    ...
    assert certificate["flags"]["BERGER_MIXED_Q2_CYCLICITY"] is True
    assert certificate["flags"]["BERGER_FIRST_GRAVITY_MAXWELL_TRANSFERRED_DRESSING"] is True
    assert certificate["first_transferred_mixed_vertex"]["term_count"] == 1474
