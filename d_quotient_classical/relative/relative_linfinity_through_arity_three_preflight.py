        ...
        "verification_receipt": {
            ...
            "tier_1": {
                "commands_and_elapsed_seconds": [
                    ...
                    {"command": "PYTHONPATH=. python3 -m unittest d_quotient_classical.relative.tests.test_relative_linfinity_through_arity_three_preflight -v", "elapsed_seconds": 0.19},
