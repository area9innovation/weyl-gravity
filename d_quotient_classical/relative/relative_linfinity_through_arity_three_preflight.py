...
def build() -> dict:
    ...
    value = {
        ...
        "verification_commands": [
            ...
            "PYTHONPATH=. python3 bridge/einstein_sector/verify_einstein_maxwell_product_linfinity.py",
        ],
        "verification_receipt": {
            ...
            "tier_1": {
                "commands_and_elapsed_seconds": [
                    {"command": "PYTHONPATH=. python3 -m d_quotient_classical.relative.relative_linfinity_through_arity_three_preflight --check --guards", "elapsed_seconds": 27.70},
                    {"command": "PYTHONPATH=. python3 d_quotient_classical/relative/verify_relative_linfinity_through_arity_three_preflight.py", "elapsed_seconds": 27.85},
                    {"command": "PYTHONPATH=. python3 -m unittest d_quotient_classical.relative.tests.test_relative_linfinity_through_arity_three_preflight -v", "elapsed_seconds": 55.93},
                    {"command": "npx --yes ajv-cli@5 compile --spec=draft2020 --strict=true -s d_quotient_classical/schema/relative-linfinity-product-taylor-input-v2.schema.json", "elapsed_seconds": 2.95},
                    {"command": "npx --yes ajv-cli@5 compile --spec=draft2020 --strict=true -s d_quotient_classical/schema/relative-linfinity-product-pbw-payload-v1.schema.json", "elapsed_seconds": 1.85},
                    {"command": "npx --yes ajv-cli@5 compile --spec=draft2020 --strict=true -s d_quotient_classical/schema/relative-linfinity-triangle-input-v2.schema.json", "elapsed_seconds": 1.91},
                    {"command": "npx --yes ajv-cli@5 validate --spec=draft2020 --strict=true -s d_quotient_classical/schema/relative-linfinity-through-arity-three-preflight-v1.schema.json -d d_quotient_classical/certificates/EINSTEIN_WEYL_RELATIVE_LINFINITY_THROUGH_ARITY_THREE_PREFLIGHT_V1.json", "elapsed_seconds": 1.76},
                ],
                "status": "PASS",
            },
            "tier_2": {
                "commands_and_elapsed_seconds": [
                    {"command": "PYTHONPATH=. python3 -m d_quotient_classical.atlas.generate_nonlinear_atlas_fragment --check", "elapsed_seconds": 0.25},
                    {"command": "PYTHONPATH=. python3 residual_atlas/validate_fragment.py d_quotient_classical/atlas/nonlinear-atlas-fragment.json", "elapsed_seconds": 0.20},
                    {"command": "PYTHONPATH=. python3 -m unittest d_quotient_classical.atlas.tests.test_nonlinear_atlas_fragment -v", "elapsed_seconds": 0.90},
                    {"command": "PYTHONPATH=. python3 bridge/einstein_sector/verify_einstein_maxwell_product_linfinity.py", "elapsed_seconds": 62.12},
                ],
                "status": "PASS",
            },
            "tier_3": {
