...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("OPEN", "The relative obstruction class factors exactly through the five Taub charges in normalized smooth finite-harmonic quotient coordinates. The required support-local lift A:K_P->C_W and its shifted 316-row cyclic carrier are now typed, but the top descent and coefficients remain open."),
