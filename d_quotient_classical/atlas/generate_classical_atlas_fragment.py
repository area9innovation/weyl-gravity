...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("OPEN", "The frozen-parallel shortcut is obstructed. The associative coefficient-jet PBW backend, corrected splittings, parent middle, shifted chain, factorized Hom adjoint, compressed Schur, upper relative-saddle row, action-derived Bach-Hessian variation and complete ten-block rank-310 cyclic SDR first variation now close exactly. Transverse metric and rank-310 Green homotopies remain open; the earlier Phi/L0/K rank screens remain backend regression data, not operator no-go theorems."),
