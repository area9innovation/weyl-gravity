...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("OPEN", "The frozen-parallel shortcut is obstructed. The associative coefficient-jet PBW backend and all four L0 plus fourteen L1 corrected-splitting jets are exact. The strict first square, parent middle associator, parent Yang-Mills identity and shifted chain now close exactly. The positive-order middle/Hom-adjoint and compressed-Schur replay remains open; the earlier Phi/L0/K rank screens remain backend regression data, not operator no-go theorems."),
        ...
        _evidence("Nariai_transverse", "Nariai_incidence", "Nariai_PBW_gate", "Nariai_jet_aware_parent", "Nariai_first_order_schur", "Nariai_Phi_only_obstruction", "Nariai_incidence_L1_rigidity", "Nariai_normalized_L0_obstruction", "Nariai_K_admissibility", "Nariai_Phi2_obstruction", "Nariai_PBW_associativity", "Nariai_coefficient_jets", "Nariai_splitting_jets", "Nariai_middle_replay", "cone"),
        "The replacement coefficient-jet algebra agrees with direct symbolic composition. The full corrected L0/L1 jet families are derived from covariant HPL plus the unique normalized strict-square correction, recover the point values, and close d_aut L0=L1 K through all required jets. The authoritative associative replay also closes M d_parent=0, both M/L1/Kp0 parenthesizations and the shifted-chain identity exactly. The old 207-term shifted defect and earlier Phi/L0/K rank screens remain regression data relative to the superseded point-only backend. Positive-order middle/Hom-adjoint jets, the compressed Schur, complete SDR and causal transfer remain open.",
    ))
    values.append(_entry(
