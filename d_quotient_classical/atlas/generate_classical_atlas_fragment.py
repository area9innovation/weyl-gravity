...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("CERTIFIED", "The global natural full-complex variation and normalized cyclic basic perturbation lemma give support-local rank-310 inclusion, projection and homotopy variations. The induced formal advanced/retarded chain contraction is exact through first order and agrees with the prior one-point geometric normalization. No nonzero-epsilon global family is claimed."),
    ...
    values.append(_entry(
        ...
        _evidence("Nariai_transverse_KS_obstruction"),
        "The branch integrates the certified tangent on every fixed compact time slab but is globally singular for every nonzero 0<|epsilon|<1. This is not a no-go for non-Einstein Bach-flat deformations, different transverse data or declared causal subdomains.",
    ))
    values.append(_entry(
