...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("OBSTRUCTED", "The frozen-parallel shortcut and a purely algebraic transverse Schur correction are obstructed. The complete first-order endpoint gauge equation has a unique solution. Phi-only repair is obstructed, and the smallest homogeneous incidence/L1 continuation is rigid. The complete 44-dimensional normalized-L0 coupled family is also inconsistent: response rank 44, augmented rank 45, with a normalized five-term witness."),
        ...
        _evidence("Nariai_transverse", "Nariai_incidence", "Nariai_PBW_gate", "Nariai_jet_aware_parent", "Nariai_first_order_schur", "Nariai_Phi_only_obstruction", "Nariai_incidence_L1_rigidity", "Nariai_normalized_L0_obstruction", "cone"),
        "Every requested curvature jet is derived and the jet-aware BGG first square and parent identity are exact. The unique 59-coefficient endpoint gauge repair does not close the separate 207-coefficient shifted-chain defect. Phi-only repair is obstructed; the homogeneous algebraic-incidence/order-at-most-one-L1 first-square map is invertible; and after adjoining every normalized algebraic L0 direction, the induced 7380-by-44 response map has rank 44 but augmented rank 45. The old Phi-only witness is reachable in that larger family and is superseded by a normalized five-term witness. Coherent K/p0, equation/constraint/cotangent variation, action-derived cyclic identification, complete SDR and causal transfer remain open.",
    ))
    values.append(_entry(
