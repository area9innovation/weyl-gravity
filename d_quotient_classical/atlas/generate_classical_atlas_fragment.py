...
def entries() -> list[dict[str, Any]]:
    ...
    values.append(_entry(
        ...
        ("OPEN", "The frozen-parallel shortcut is obstructed. The associative coefficient-jet PBW backend, corrected splittings, parent middle, shifted chain, factorized Hom adjoint and compressed Schur now close exactly through the required fifth-order curvature jets. The upper relative-saddle row, complete rank-310 SDR and causal transfer remain open; the earlier Phi/L0/K rank screens remain backend regression data, not operator no-go theorems."),
        ...
        _evidence("Nariai_transverse", "Nariai_incidence", "Nariai_PBW_gate", "Nariai_jet_aware_parent", "Nariai_first_order_schur", "Nariai_Phi_only_obstruction", "Nariai_incidence_L1_rigidity", "Nariai_normalized_L0_obstruction", "Nariai_K_admissibility", "Nariai_Phi2_obstruction", "Nariai_PBW_associativity", "Nariai_coefficient_jets", "Nariai_splitting_jets", "Nariai_middle_replay", "Nariai_factorized_schur", "cone"),
        "The replacement coefficient-jet algebra agrees with direct symbolic composition. Corrected HPL splittings close the first square; the associative replay closes the parent and shifted-chain identities; and factorized adjunction before PBW normal ordering now gives the exact cyclic Hom adjoint and compressed Schur through fifth-order curvature jets. The normal-table adjoint, old 207-term shifted defect and earlier Phi/L0/K rank screens remain negative regression data only. The upper relative-saddle row, complete SDR and causal transfer remain open.",
    ))
    values.append(_entry(
