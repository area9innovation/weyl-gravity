...
def verify() -> None:
    ...
    if (
        ...
        or "15/16<kappa<17/16" not in active_clock["claim_boundary"]
        or "q=1/4 is the first clock/principal bifurcation"
        not in active_clock["claim_boundary"]
        or "not a fixed-action stability claim" not in active_clock["claim_boundary"]
