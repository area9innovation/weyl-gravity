...
|---|---|---|---|
| classical | `SECTOR_DEPENDENT_WITH_SINGLE_SCALAR_CLOCK_OBSTRUCTION` | D_compact is charged on compact_P_lin and gauge on compact_P_Taub0/compact_P_der; the one-real-scalar exact-cylinder clock background is obstructed. | backreacted scalar geometry, Weyl-invariant composite/two-field clock, or separately declared reference matter |
...
`BACKREACTED_OR_COMPOSITE_CLOCK_MODEL`: Do not reuse the obstructed one-real-scalar exact-cylinder background; construct one backreacted, composite/two-field, or separately declared reference-matter clock and make downstream teams import it by hash.

## Imported evidence

- `classical`: `d_quotient_classical/certificates/CLASSICAL_D_QUOTIENT_STATUS.json` at `704787c06de9e3746c1230e130bb652cb787a825`, SHA-256 `9aa1d40baeafc63ba75a0c96ccbe084bb8181f08713f41c1b7d4fe25faebf867`
