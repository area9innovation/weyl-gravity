...
additive-resolution Hamiltonian or semigroup.  A quantum-stochastic noise
dilation or an unbounded rigged continuation is still required; a fourth
jump remains open.
Resolution locality is not spacetime locality; the complete physical
S-matrix, non-strongly-ordered many-body probabilities, and Eq.~(19) remain
open.
\end{remark}
