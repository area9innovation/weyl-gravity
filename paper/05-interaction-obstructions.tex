...
physically affiliates the first three edge marks only.  The 72 higher marks
still lack nested continuum columns, so the next physical gate is the
six-point nested direct integral rather than a scalar fourth-rate calculation.
