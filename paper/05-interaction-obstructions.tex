...
on the declared two-species carrier.  The next candidate must retain the
constant/linear parent jet and singleton/pair spectator profile as separate
gradings.  Resolution locality is not spacetime locality; positivity of that
enlarged carrier, the complete physical S-matrix, non-strongly-ordered
many-body probabilities, and Eq.~(19) remain open.
\end{remark}
