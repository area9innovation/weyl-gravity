...
for every admissible monotone profile.  This
\texttt{LOCAL-ALGEBRAIC}, \texttt{REDUCED-MODE} result is not time evolution,
a spacetime-local detector, the finite NLO probability, or Eq.~(19).
\end{remark}
