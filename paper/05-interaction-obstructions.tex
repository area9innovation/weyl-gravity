...
therefore logarithmically non-trace-class and does not select $1/48$; the next
gate is a regulator-response-cancelling asymptotic Hamiltonian or hard matching
operator.
...
still cannot predict $1/48$.  This exact
\texttt{LOCAL-ALGEBRAIC}, \texttt{REDUCED-MODE} classification is recorded by
\texttt{REVERSE\_PHYSICS\_BT\_FULL\_OFF\_}
\allowbreak\texttt{RESONANT\_PROJECTOR\_V1}; it neither excludes a
renormalized asymptotic Hamiltonian nor establishes a complete probability.
\end{remark}
