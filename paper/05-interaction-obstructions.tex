...
state is not the state dynamically selected at two emissions.  Two moments
do not determine a unique positive non-Gaussian completion.  Resolution
locality is not spacetime locality; the complete physical S-matrix, the
non-strongly-ordered six-body probability, and Eq.~(19) remain open.
\end{remark}
