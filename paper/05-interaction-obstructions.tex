...
Born-trace evaluation --- open, and the fixed-shell route to it is
excluded rather than merely unattempted: on a truncated shell the
charge-null lemma's hypothesis is absent and its conclusion fails by
exactly the obstruction squared (Section~\ref{sec:discussion}).
