...
radial daughter measure now reduces those three flat-slice jets to one soft
...
cross-Krein construction now implements the covariant squeeze on paired
...
The full off-resonant composition is now also known exactly.  Keep
...
The global broken-vacuum orbit can now be added exactly without a c-number
