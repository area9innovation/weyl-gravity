...
(Remark~\ref{rem:btaxis}); a full NLO quotient trace,
dressed-state or resummed completion, and gravitational lift of that infrared
statement --- open.
...
Remark~\ref{rem:btaxis} supplies its first complete
collinear logarithmic obstruction.  Its successor must change infrared
architecture explicitly by deriving a distributional extension from the
generalized Born rule, including degenerate incoming or dressed states, or
resumming the collinear sector before evaluating the quotient trace.  The
