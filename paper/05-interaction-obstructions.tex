...
sector.  This exact distinction is recorded by
\texttt{REVERSE\_PHYSICS\_BT\_}\allowbreak
...
or $-3/512$ after multiplication by the Born coefficient.  Certificate
\texttt{REVERSE\_PHYSICS\_BT\_PHYSICAL\_SHELL\_}
\allowbreak\texttt{PSEUDOUNITARY\_COMPLETION\_V1} supplies an exact finite
$\mathbb Q(\sqrt3)$ isometric witness and proves independence from phases and
anti-Hermitian second-order freedom.  It does not construct the continuum
...
\texttt{REVERSE\_PHYSICS\_BT\_LOG\_SHELL\_MOLLER\_LIMIT\_V1}
