...
second-order Green-resolvent pole.  In parallel, the polar problem should be
reorganized around the standard Zerilli--Moncrief map and the target-gauge
Maxwell scalar, so that only the lift, endpoint units, and extension shears
are computed afresh.
