...
def build() -> dict[str, Any]:
    ...
    return {
        ...
        "next_gate": {
            "status": "FIX_COVARIANT_SUBTRACTION_THEN_ASSEMBLE_RENORMALIZED_MIXED_ROWS",
            "required_inputs": [
                ...
                "a local covariant subtraction/distribution extension identifying the triangle-corner and bubble-endpoint carriers, followed by renormalized mixed physical rows and an exact M14 disposition",
