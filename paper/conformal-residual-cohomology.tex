...
module.  A direct invariant two-wave factorization of the gauge-completed
Bach operator is ruled out in the stated complete family.
...
The
  ...
  all $386$ prolonged rows.  What remains is the causal quasi-isomorphism,
  residual endpoint recovery, equivariant pairing
  transport, Green/current identification, distributional/Hadamard
  completion, and alternative boundary polarizations.  A canonical endpoint
...
rows.  Ten curvature/current/causal flags are true; the remaining five
transport or canonical-witness flags keep the final covariant $H^4$ flag
false.
...
\begin{equation}\label{eq:open-curvature-flags}
 ...
 \end{aligned}
\end{equation}
Ten flags in \eqref{eq:open-curvature-flags} are true: the curved equations,
...
comparison and the all-row causal Green homotopy.  The remaining five flags
are the prolonged witness, canonical curvature Green operators, causal
quasi-isomorphism, residual endpoint recovery, and equivariant transport.
They remain false.  In particular, the paper now
...
certified chain homotopy.  The certified odd cyclic mapping cylinder gives the
quadratic parent
\begin{equation}
...
remains false while those downstream maps are uncertified.  The known
...
\eqref{eq:full-prolonged-causal-homotopy} is exact.  The remaining five false
witness/transport flags in \eqref{eq:open-curvature-flags}, including the
causal quasi-isomorphism, endpoint recovery and equivariant transfer, as well
as Hadamard completion and uniqueness among boundary or deparametrized
polarizations, remain separate analytic questions.  The final
...
with the transferred causal pairing remains downstream.  The prolonged Green
witness and canonical causal Green operators remain open, while the BV causal
homotopy is exact.  The causal quasi-isomorphism, endpoint recovery and
$SO(4,2)$-equivariant transport also remain open.
...
vector propagation blocks.  Since the causal quasi-isomorphism, endpoint
recovery, equivariant transfer and Green/current comparison are not yet
certified,
...
prolonged.\\
Curvature causal homotopy and final covariant $H^4$ & Homotopy exact; final
fail-closed &
Ten flags in \eqref{eq:open-curvature-flags} are true and five
witness/transport flags remain false.  The local all-row prolongation, BV
...
identity.  The remaining work is the causal quasi-isomorphism, residual
endpoint recovery, and equivariance; Green/current equality is further
downstream.  Consequently the causal quasi-isomorphism
