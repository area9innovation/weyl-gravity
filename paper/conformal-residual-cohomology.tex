...
linearized-Weyl symbol is the isomorphism $\frac14 I_2$.  A ten-component
electric/magnetic Weyl candidate has a positive STF symmetrizer, speeds
$0,\pm\frac12,\pm1$, and the correct principal div--curl constraint
identity.  These are principal-symbol facts only.  The exact curved
Bianchi--Bach evolution, full constraint propagation, support-local
prolongation retract, causal curvature Green operators, final covariant
$H^4$ transport, and a Hadamard theory remain open.  A direct same-bundle
...
variables rather than hide it in a $24$-component scalar-wave block.  Exact
curved electric/magnetic equations, constraint propagation, a support-local
prolongation retract, causal curvature Green operators,
...
module and the reduced Weyl symbol is $\frac14 I_2$.  A symmetric-hyperbolic
electric/magnetic principal block has been certified, but it has not yet been
derived with all lower-order terms from the curved Bianchi and Bach
identities.  Consequently the final covariant $H^4$ flag remains false.
...
\end{equation}
On the ten-dimensional bundle
$\operatorname{STF}_2(S^3)\oplus\operatorname{STF}_2(S^3)$, the candidate
principal equations
\begin{equation}\label{eq:EB-candidate-principal}
 \partial_tE-\operatorname{curl}_2B=\text{lower order},\qquad
 \partial_tB+\operatorname{curl}_2E=\text{lower order}
\end{equation}
have $A^0=I_{10}$ and a positive STF symmetrizer.  For every unit spatial
covector their complete characteristic speeds, including constraint and
auxiliary channels, are
\begin{equation}
 0,\quad \pm\frac12,\quad \pm1,
\end{equation}
each with multiplicity two.  The physical transverse sector has speeds
$\pm1$, and exact constant-curvature symbol algebra gives
...
\end{equation}
These facts certify a candidate symmetric-hyperbolic principal block; they
do not derive \eqref{eq:EB-candidate-principal} from the curved linearized
Bianchi and Bach equations or prove lower-order constraint closure.

The selected causal route therefore has five explicit open flags:
\begin{equation}\label{eq:open-curvature-flags}
 ...
 \end{gathered}
\end{equation}
All five remain false.  In particular, the paper does not yet construct
$G_\pm$, causal Green homotopies, or the causal quasi-isomorphism.  The known
...
is an isomorphism.  The candidate electric/magnetic block has a positive
principal symmetrizer and causal characteristic speeds, but its full curved
Bianchi--Bach equations and constraint propagation have not been derived.
The five open flags in \eqref{eq:open-curvature-flags}, the resulting causal
...
covariant $H^4$ transport is therefore not yet a theorem.  The exact ranks in
...
curved electric/magnetic Weyl prolongation, whose exact equations, symmetric
hyperbolicity, constraint propagation, local prolongation retract, and
causal Green operators remain open.  Alternative boundary polarizations,
...
Electric/magnetic Weyl principal candidate & Exact principal-symbol
certificate only & The ten-component STF block has a positive symmetrizer,
speeds $0,\pm\frac12,\pm1$, and
$\operatorname{div}\operatorname{curl}_2
=\frac12\operatorname{curl}_1\operatorname{div}$.  It has not yet been
derived, including lower-order terms, from the curved Bianchi--Bach system.\\
Curvature causal realization and final covariant $H^4$ & Open, fail-closed &
The five flags in \eqref{eq:open-curvature-flags} remain false.  Consequently
the causal quasi-isomorphism and \texttt{final\_covariant\_H4} remain false;
