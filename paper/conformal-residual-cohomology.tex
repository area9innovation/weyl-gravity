...
\begin{equation}\label{eq:relative-curvature-temporal-diagonal}
 ...
 \qquad D(dt)^{-1}=D(dt).
\end{equation}
Consequently the exact pair-$1+6$ Schur term is
$BD^{-1}C=-\Pi_{\rm vector}$.  Retaining the rank-three scalar diagonal gives
...
arbitrary-covector characteristic polynomial, positive symmetrizer,
