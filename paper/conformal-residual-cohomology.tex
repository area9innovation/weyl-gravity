...
Nine curvature/current flags are true; the remaining six causal flags keep the
...
graph.  The displayed $66\to30$ component hashes are a flat-Fourier regression
of the universal pointwise summand; curved exactness comes from the factorized
curved-$Q$ certificate, not an expanded $30\times30$ coefficient table.
What remains is
...
projector are complete.  The remaining work is the endpoint Green
