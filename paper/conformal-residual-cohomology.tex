...
The corresponding rotation-generator commutants have not yet been generated
coefficientwise, so completeness of the $162$-dimensional family is scoped
to that multiplicity ledger.
...
This is not yet the saddle Schur term $BD^{-1}C$.  The actual
$92$-component curvature temporal diagonal, its Douglis inverse, and the
complete $116\times116$ weighted symbol have not been assembled.  Thus no
full-rank temporal-saddle or hyperbolicity claim follows from
\eqref{eq:relative-pair16-numerator}.
