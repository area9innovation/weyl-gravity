...
Krein--Fock theorem, not a covariant Sobolev or distributional theorem for
metric fields.  We claim neither an integrated $SO(4,2)$ group
...
Covariant metric-field completions and alternative boundary polarizations
...
block.  This does not construct a covariant Sobolev completion of metric
fields or integrate the unbounded Lie-algebra action to $SO(4,2)$.
...
complex.  It does not identify spacelike-compact or distributional metric
cohomology, construct Green operators, or prove equivalence with a covariant
metric-field Sobolev topology.  Green-hyperbolic complexes and causal
homotopies remain natural tools for that later problem
\cite{BaerGreenHyperbolic,GreenHyperbolic}.  Nor does the theorem make the
choice to gauge $D$
universal: if $D$ is retained as a Hamiltonian or boundary charge, the
Cartan contraction is not part of that physical complex.
...
\paragraph{The algebraic bridge, energy completion, and covariant boundary.}
...
closed range, and unchanged $H^4$.  Extension of the metric-field complex to
a covariant Sobolev, distributional, or Green-hyperbolic category remains a
separate analytic question, as does uniqueness among boundary or
deparametrized polarizations.  The exact ranks in
...
unchanged.  Covariant metric-field completion, alternative boundary
...
establish the energy-mode completion or a covariant metric Sobolev
isomorphism.\\
...
Covariant or alternative-boundary BV--BFV realization & Not claimed & The
energy-mode theorem does not establish a metric-field Sobolev or
distributional complex, Green-hyperbolic equivalence, group exponentiation,
or uniqueness among boundary, clock, asymptotic, or deparametrized
polarizations.\\
