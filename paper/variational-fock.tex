...
Theorem~\ref{thm:groundstate}).  The artifact is the directory
\texttt{physics/symplectic-reconstruction} of the repository of
\cite{companion} (scripts \texttt{symbolic/verify\_variational\_fock.py},
\texttt{symbolic/verify\_paper2\_referee.py},
\texttt{numeric/distortion\_scan.py}, \texttt{numeric/cartan\_checks.py};
SymPy 1.14.0, Python 3.14; the release tag \texttt{paper2-v1.2} fixes the
commit).
