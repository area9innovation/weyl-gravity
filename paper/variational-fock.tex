...
$U(1)^2$ of $SO(2,\C)^2$.
(iii) The theorem gives the finite-dimensional Kempf--Ness-type picture
concretely: the Gram map $C\mapsto CC^{\dg}$ measures the distance of a coset
element from the unitary locus, and \eqref{eq:xformula} shows how the two
rapidities $(a,b)$ add in quadrature with the PU rapidity $r$.
\end{remark}
