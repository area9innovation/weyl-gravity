...
def payload() -> dict:
    return {
        ...
        "result_id": "PAPER17_PUBLICATION_CONSOLIDATED_SPINE",
        ...
        "does_not_establish": [
            ...
            "specified astrophysical matter source or detector sensitivity",
