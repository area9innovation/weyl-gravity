...
does not imply absence of a doubled Krein-type structure.
\end{abstract}
...
survives interaction.  Thus ``canonical'' and ``optimal'' in Papers~I--II
are kinematic statements about the free theory, not claims of interacting
stability.
...
positive completion.  A full-field complex spectrum, a quantum operator
implementing the doubled exchange, and the interacting-gravity calculation
remain open.
...
generally than in a finite oscillator.  At the massless perfect-square
