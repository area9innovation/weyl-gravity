...
The homogeneous reference-clock theorem remains valid.  The homogeneous
positive-sign quartic stealth family is also obstructed by turning points and
finite-time poles, so the next search must use positive-energy Bach-sourced
non-conformally-flat geometry or an inhomogeneous stress-free stealth
mechanism.  Together these scoped results supply the scalar-clock
