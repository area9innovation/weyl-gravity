...
positive-energy backreacted search now has an exact candidate.  A static
...
not itself a legal charge variation.  It is therefore a genuine
physical-clock candidate rather than a cost-free gauge label, while existence
of an allowed fixed-coupling tangent with $\delta Q_R\ne0$ remains open.  This
is not yet the total covariant $D$-charge or all-row BV reduction theorem. Together
...
\item alternative boundary, relative, and deparametrized polarizations, in
which $D$ or other generators may remain charges, together with the covariant
charge and BV audit of the positive Berger-clock background;
