...
the total helical generator presymplectically null.  A complete $54$-row
...
\item Paper~IX constructs a healthy Berger phase clock and proves that total
$D$ remains gauge linearly and causally null-homotopic through arity three on
the declared fixed-coupling classical sector.
\end{enumerate}
...
from the still-open Berger-clock charge/BV audit, boundary, interacting, and
quantum questions.
...
time translation remains gauge after a physical clock and low-order
