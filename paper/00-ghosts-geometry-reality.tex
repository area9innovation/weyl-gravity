...
$Q_R=V_0\alpha_Bq\sqrt{1-4q}$ and obeys
$\mathcal L_D=\omega R$ on the background.  It is therefore a genuine
physical-clock candidate rather than a cost-free gauge label.  This is not
yet the total covariant $D$-charge or all-row BV reduction theorem.  Together
