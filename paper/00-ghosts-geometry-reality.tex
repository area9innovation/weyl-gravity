...
Taub reduction, relational clocks, and boundary dependence.  The first
...
rows now contract by an exact support-local cyclic SDR, but this is not yet
the retained all-row BV reduction or nonlinear
stability theorem. Together
these scoped results supply the scalar-clock
half of the Paper~IX gate.  The paper is not part of the present eight-paper
theorem sequence until at least one complete boundary or interaction theorem
...
which $D$ or other generators may remain charges, together with the covariant
retained-operator, nonminimal, causal, and stability audit of the positive Berger-clock
background;
