...
missing representation is a temporal Maxwell/emitter-antifield covariance
module with \(A^+/\tau/K\) and cyclic \(K^+/\tau/A\) descendants.  Since the
arity-two admissible locus is empty, no common-action quartic \(q_3\) is
promoted; the previous \(-4g_0h_0\) arity-three coefficient remains only a
diagnostic.  In particular, although the ambient Maxwell/Berger-\(U(1)\)
