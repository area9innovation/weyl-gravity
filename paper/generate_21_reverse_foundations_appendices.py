...
def build(data: dict, assemblies: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "The completion atlas keeps eleven lifecycle stages separate on seven candidate architectures.  None of the branches is a completed Lorentzian quantum theory.  The strict 386-row branch now has an exact graph-coordinate unary differential, SDR, transported suspension, represented advanced/retarded Green names, the local cylinder-flow action, and an exact cyclic q2 stabilization.  The stabilization is a receiver construction, not an authoritative classical import; Gate A remains fail closed for source-certified q2 theory identity and the residual data.",
            "",
            r"\begingroup",
            r"\scriptsize",
            r"\setlength{\tabcolsep}{3pt}",
            r"\begin{longtable}{@{}rp{0.25\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.39\textwidth}@{}}",
            r"\caption{Ranked next certificates in Lorentzian Weyl BV completion atlas V17.}\label{tab:lorentzian-weyl-completion-routes}\\",
            r"\toprule",
