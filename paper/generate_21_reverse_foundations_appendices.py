...
def build(data: dict, assemblies: dict) -> str:
    ...
    lines.extend(
        [
            ...
            r"\caption{Ranked next certificates in Lorentzian Weyl BV completion atlas V22.}\label{tab:lorentzian-weyl-completion-routes}\\",
            r"\toprule",
