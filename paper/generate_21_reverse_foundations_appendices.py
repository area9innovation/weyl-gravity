...
def build(data: dict, assemblies: dict) -> str:
    ...
    lines.extend(
        [
            ...
            rf"The completion atlas keeps eleven lifecycle stages separate on seven candidate architectures.  None of the branches is a completed Lorentzian quantum theory.  The strict 386-row branch now has an exact graph-coordinate unary differential, SDR, transported suspension, represented advanced/retarded Green names, the local cylinder-flow action, and linked common source q2/q3 snapshots.  The arity-two layer has zero q1/q2, cyclicity, and stationary D/q2 defects.  The arity-three layer contains {completion['strict_source_q3_common_assembly']['source_q3_families']} exhaustive source families and {completion['strict_source_q3_common_assembly']['auxiliary_ordered_q3_coefficients']:,} auxiliary coefficients; its arity-three, cyclicity modulo horizontal boundary, and stationary D/q3 defects are all zero.  Gate A and q2/q3 Green compatibility remain fail closed.",
            "",
            r"\begingroup",
            r"\scriptsize",
            r"\setlength{\tabcolsep}{3pt}",
