...
def build(data: dict, assemblies: dict) -> str:
    ...
    lines.extend(
        [
            ...
            r"The completion atlas keeps eleven lifecycle stages separate on seven candidate architectures.  None of the branches is a completed Lorentzian quantum theory.  The strict 386-row branch now has an exact graph-coordinate unary differential, SDR, transported suspension, represented advanced/retarded Green names, the local cylinder-flow action, and a complete common source q2.  The source q2 combines the minimal and auxiliary families, extends by zero across the receiver-added split cone, and transports to graph coordinates with zero q1/q2, cyclicity, and stationary D/q2 defects.  An exact append-only c-star translation repairs 336 defects in the historical auxiliary convention.  The metric-dependent auxiliary q3 and its common arity-three replay remain open.  Gate A and general lambda-squared causal source closure therefore remain fail closed.",
            "",
            r"\begingroup",
            r"\scriptsize",
            r"\setlength{\tabcolsep}{3pt}",
