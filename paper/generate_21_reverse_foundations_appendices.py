...
def build(data: dict) -> str:
    ...
    lines = [
        ...
        r"Evidence & The complete literature register, local-certificate register, and usage crosswalk for all 69 records. \\",
        r"\bottomrule",
        r"\end{tabularx}",
        r"\end{center}",
        "",
    ...
    lines.extend(
        [
            ...
            r"\caption{Complete literature reference and evidence register (51 records).}\label{tab:complete-literature-register}\\",
            r"\toprule",
    ...
    lines.extend(
        [
            ...
            r"\setlength{\tabcolsep}{3pt}",
            r"\begin{longtable}{@{}p{0.36\textwidth}p{0.58\textwidth}@{}}",
            r"\caption{Complete local result and certificate register (18 records).}\label{tab:complete-local-register}\\",
            r"\toprule",
    ...
    lines.extend(
        [
            ...
            r"\caption{Complete crosswalk from the atlas views to all 69 evidence records.}\label{tab:evidence-usage-crosswalk}\\",
            r"\toprule",
