...
def build(data: dict, assemblies: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "The completion atlas keeps eleven lifecycle stages separate on seven candidate architectures.  None of the branches is a completed Lorentzian quantum theory.  The strict 386-row branch now has an exact graph-coordinate unary differential, SDR, transported suspension, represented advanced/retarded Green names, the local cylinder-flow action, an exact cyclic q2 stabilization, both first nonlinear causal-response names, honest support domains for every finite polarized candidate tree, unique Catalan-weighted formal fixed-point coefficients, and the correctly typed field-equation inverse on Noether-compatible sources and fields modulo gauge.  A full ungauge-fixed inverse is exactly obstructed.  Separately, the authoritative six-generator minimal carrier now has its arbitrary-input q3, complete arity-three identity, and quartic cyclicity.  The 386-row nonlinear objects remain receiver constructions without a certified nonminimal theory identity; Gate A remains fail closed for that identity and the residual data.",
            "",
            r"\begingroup",
            r"\scriptsize",
            r"\setlength{\tabcolsep}{3pt}",
            r"\begin{longtable}{@{}rp{0.25\textwidth}p{0.12\textwidth}p{0.12\textwidth}p{0.39\textwidth}@{}}",
            r"\caption{Ranked next certificates in Lorentzian Weyl BV completion atlas V24.}\label{tab:lorentzian-weyl-completion-routes}\\",
            r"\toprule",
