...
def build() -> dict:
    ...
    payload = {
        ...
        "does_not_establish": [
            ...
            "the authoritative twenty-export, seven-hash classical Gate A from the linked source-q2/q3 snapshot",
            "a complete Lorentzian off-shell BV propagator",
            "q2/q3 compatibility with advanced or retarded Green homotopies from the local source assembly",
