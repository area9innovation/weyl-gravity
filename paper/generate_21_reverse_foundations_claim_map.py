    ...
    payload = {
        ...
        "claims": [
            ...
            },
            {
                ...
                "statement": "The thirty-row endpoint Gate pairing has 54 nonzero ordered entries and determines the exact suspension character R=diag(-I_5,I_10,I_10,-I_5). With A^ddagger=R A^{sharp_G} R, the transported advanced/retarded Green adjoint relation replays without a residual sign. Extending R as I_356 direct-sum R over the certified cyclic 356+30 projector split gives 376 positive and 10 negative signs and establishes the full projector-level suspended Green adjoint. The 356 component basis and pairing coefficients are not serialized, and local D, same-carrier q2 compatibility, Gate A, Hadamard and QME remain open.",
