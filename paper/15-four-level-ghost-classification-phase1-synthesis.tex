...
the additional axial and polar solutions at the specified
$(\ell,m\omega)=(2,3/5)$ fixture.  In the
...
negative-frequency coefficients.  On the positive-frequency space define
\begin{equation}
...
Here the Schwarzschild parameter is normalized to $m=1$, so the horizon is
$r=2$ and the quoted frequency means $m\omega=3/5$.  In ingoing
...
\textbf{Background.} Schwarzschild exterior with $m=1$ and horizon $r=2$.\par
