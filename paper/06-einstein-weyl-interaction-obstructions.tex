...
required.  Its construction is explicitly open, and gravity would still
require an independent BRST-compatible carrier rather than importing either
the scalar coefficient or this reduced-mode obstruction.
...
show that the required Jordan term exists or that BT dynamics generates it.
The verified
