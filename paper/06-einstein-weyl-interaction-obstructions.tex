...
unknown leading--sixth-order cross is identical for both effects.  The two
absolute $q_8$ coefficients and selection by the public BT dynamics remain
open, while an explicit external pointer Hamiltonian realizes the finite
...
\]
Neither absolute $q_8$ coefficient is computed: both the complete $X_4$
Gram data and the common $X_2$--$X_6$ interference remain open.  This is an operational
...
absolute $q_8$, Eq.~(19), or any metric BV--BRST or Lorentzian-causal carrier.
