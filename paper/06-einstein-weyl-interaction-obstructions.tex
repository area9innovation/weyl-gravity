...
The remaining scalar gate is equality with the finite-duration auxiliary
Dyson packet kernel, not another covariant loop integral.  No coefficient or
carrier statement transfers to the gravitational BRST complex.
