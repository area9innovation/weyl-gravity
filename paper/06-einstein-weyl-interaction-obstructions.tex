...
deltas.  A matched order-\(g^5\) normalized Born cut must now be derived before
any finite-time or all-time \(q_{10}\), RG cancellation, metric BV--BRST
transfer or Lorentzian causal claim.
