...
declared final-pair cylinder.  Resolution dilation is not time evolution, and
the scalar detector trace, cancellation, and coefficient do not transfer to
the metric BV complex or establish a \texttt{LORENTZIAN-CAUSAL} result.
