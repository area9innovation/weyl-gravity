...
absolute $q_8$ coefficients and dynamical detector selection remain open,
and no part transfers to gravity.
\end{abstract}
...
selected by BT dynamics and not a gravitational result.
