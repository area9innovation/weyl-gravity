...
or all-order inductive operator is constructed.  Neither scalar polar range,
either cumulative resolution measure, nor its auxiliary translations
transfers to the metric BV complex.
