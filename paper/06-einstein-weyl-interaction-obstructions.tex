...
hence both projectors commute with $\kappa_{m tot}$.  Coherent ten-channel
...
physical probability.  The $O(\lambda^9)$ remainder, overlap sectors,
Eq.~(19), metric BV--BRST transfer and Lorentzian causality remain open.
