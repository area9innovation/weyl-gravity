...
complete order-$\lambda^6$ probability; in particular a possible dressed-
source term already enters at probability order $\lambda^5$, before the loop
and survival completion, and none of these statements transfers to gravity.
