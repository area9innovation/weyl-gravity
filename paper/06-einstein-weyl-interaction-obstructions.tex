...
$5/64$ on the quotient fibre.  Certificate
\texttt{REVERSE\_PHYSICS\_BT\_SIX\_POINT\_}
\allowbreak\texttt{PROFILE\_QUOTIENT\_COMPLETION\_V1}
leaves the third $27/400$ species jump open pending a seven-point pre-trace
calculation.  Neither this scalar quotient, the growing history carrier, nor
its jump rates transfer to metric BV data.
