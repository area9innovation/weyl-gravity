...
volume-uniform strictly positive lower bound.  The recorded and symmetric bright-port absolute
...
\par\noindent
certifies this finite-volume auxiliary-scalar coefficient.  It does not
construct continuum packets, compute either still-open bright/recorded
coefficient, or transfer the result to the metric theory.  This is an operational
