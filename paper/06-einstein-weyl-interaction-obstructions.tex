...
$-\epsilon\|Y_4(c_1)-Y_4(c_2)\|^2/2$.  The full $q_8$ coefficient and
dynamical detector selection remain open, and no part transfers to gravity.
\end{abstract}
...
$-\epsilon\|Y_4(c_1)-Y_4(c_2)\|^2/2$ at order $\lambda^8$, whose complete
ledger is not computed.  This is an operational
