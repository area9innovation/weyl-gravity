...
The physical neutral choice depends on a missing broken-vacuum zero-mode
pushforward and supplies no gravitational or causal normalization.
\end{abstract}
...
The scalar oscillatory and squeezed sectors are also ruled out as the missing
normalization source: both lie in the strictly negative BT charge radical and
are trace-null.  Conversely, the free cross-CCR and projection idempotence
