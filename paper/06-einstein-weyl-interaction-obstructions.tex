...
The scalar oscillatory and squeezed sectors are now also ruled out as the
missing normalization source: both lie in the strictly negative BT charge
radical and are trace-null.  What remains absent is the neutral coisometric
pushforward/range data, not a phase prescription that gravity could copy.
