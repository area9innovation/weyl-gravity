...
\par\noindent
affiliates only the first three scalar edge marks; the other 72 still lack
nested continuum domains.  Neither the scalar polar ranges nor their
auxiliary Abel translations transfer to the metric BV complex.
