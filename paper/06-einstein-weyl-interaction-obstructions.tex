...
$\lambda^8/[2048\pi^4\kappa^4L_xL_y^2L_z^2]$, with the leading survival
coefficient fixed by pseudo-unitarity.  It is a scalar auxiliary-sector
result, not a transported perfect-square source, metric-BV result, or
all-time probability.
...
$-A_4^*A_4/2$.  The public calculation does not yet supply that virtual graph
or a common-domain BT evolution, so the Julia complement is an operational
detector completion, not a dynamical affiliation.  The zero-gap limit,
