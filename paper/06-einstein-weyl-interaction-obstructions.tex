...
\par\noindent
therefore extends scalar physical continuum affiliation to marks $0$ through
$14$; the other sixty remain quotient-only.  Neither scalar polar range, its
cumulative resolution measure, nor its auxiliary translations transfer to
the metric BV complex.
