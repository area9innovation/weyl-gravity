...
the artifact is the directory \texttt{physics/symplectic-reconstruction}
of the repository accompanying the companion series
\cite{companion1,companion2,companion3} (scripts
\texttt{symbolic/verify\_gravity\_\{reduction,completion,spectral\}.py},
run with \texttt{python3}; SymPy 1.14.0, NumPy 2.4.4, Python 3.14; the
release tag \texttt{paper4-v1.0} fixes the commit).  The
...
Bateman--Turok-type Krein form is its resonant continuation.
...
positivity of physical probabilities.  We have not performed these
computations; the free theorem is neutral on the outcome.
