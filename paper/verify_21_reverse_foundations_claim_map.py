...
def main() -> int:
    ...
    gate_v4 = json.loads((ROOT / data["authorities"]["classical_import_gate_v4"]["path"]).read_text())
    ...
    require(gate_v4["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED", "Gate-A v4 promoted")
    require(gate_v4["gate_disposition"]["accepted_common_snapshot_hashes"] == 0, "Gate-A v4 common hash promoted")
