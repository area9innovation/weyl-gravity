...
def main() -> int:
    ...
    classical_diff_auxiliary = json.loads((ROOT / data["authorities"]["classical_diff_auxiliary_bv_representation"]["path"]).read_text())
    ...
    shifted_mass_q2 = json.loads((ROOT / data["authorities"]["strict_386_shifted_mass_bv_q2_lift"]["path"]).read_text())
    diff_auxiliary_v2 = json.loads((ROOT / data["authorities"]["strict_386_diff_auxiliary_bv_representation_v2"]["path"]).read_text())
    source_q2 = json.loads((ROOT / data["authorities"]["strict_386_source_q2_common_assembly"]["path"]).read_text())
    gate_v14 = json.loads((ROOT / data["authorities"]["classical_import_gate_v14"]["path"]).read_text())
    completion_atlas_v32 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v32"]["path"]).read_text())
    classical_quartic_mass = json.loads((ROOT / data["authorities"]["classical_shifted_auxiliary_quartic_mass"]["path"]).read_text())
    shifted_mass_q3 = json.loads((ROOT / data["authorities"]["strict_386_shifted_mass_bv_q3_lift"]["path"]).read_text())
    source_q3 = json.loads((ROOT / data["authorities"]["strict_386_source_q3_common_assembly"]["path"]).read_text())
    gate_v15 = json.loads((ROOT / data["authorities"]["classical_import_gate_v15"]["path"]).read_text())
    completion_atlas_v33 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v33"]["path"]).read_text())
    residual_zero_modes = json.loads((ROOT / data["authorities"]["strict_residual_zero_mode_payload"]["path"]).read_text())
    gate_v16 = json.loads((ROOT / data["authorities"]["classical_import_gate_v16"]["path"]).read_text())
    completion_atlas_v34 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v34"]["path"]).read_text())
    centered = json.loads((ROOT / data["authorities"]["strict_centered_cohomology_payload"]["path"]).read_text())
    gate_v17 = json.loads((ROOT / data["authorities"]["classical_import_gate_v17"]["path"]).read_text())
    completion_atlas_v35 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v35"]["path"]).read_text())
    residual_sdr_type_audit = json.loads((ROOT / data["authorities"]["strict_residual_sdr_type_audit"]["path"]).read_text())
    gate_v18 = json.loads((ROOT / data["authorities"]["classical_import_gate_v18"]["path"]).read_text())
    completion_atlas_v36 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v36"]["path"]).read_text())
    endpoint_sdr_binding = json.loads((ROOT / data["authorities"]["strict_386_common_endpoint_sdr_binding"]["path"]).read_text())
    gate_v19 = json.loads((ROOT / data["authorities"]["classical_import_gate_v19"]["path"]).read_text())
    completion_atlas_v37 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v37"]["path"]).read_text())
    local_cyclic_pairing = json.loads((ROOT / data["authorities"]["strict_386_local_cyclic_pairing_closure"]["path"]).read_text())
    gate_v20 = json.loads((ROOT / data["authorities"]["classical_import_gate_v20"]["path"]).read_text())
    completion_atlas_v38 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v38"]["path"]).read_text())
    residual_comparison = json.loads((ROOT / data["authorities"]["strict_endpoint_to_residual_spectral_comparison"]["path"]).read_text())
    gate_v21 = json.loads((ROOT / data["authorities"]["classical_import_gate_v21"]["path"]).read_text())
    completion_atlas_v39 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v39"]["path"]).read_text())
    ...
    m3rc_action_support = json.loads((ROOT / data["authorities"]["strict_m3rc_action_support_dual_identification"]["path"]).read_text())
    gate_v24 = json.loads((ROOT / data["authorities"]["classical_import_gate_v24"]["path"]).read_text())
    completion_atlas_v42 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v42"]["path"]).read_text())
    typed_residual_cyclicity = json.loads((ROOT / data["authorities"]["strict_typed_residual_cyclicity"]["path"]).read_text())
    gate_v25 = json.loads((ROOT / data["authorities"]["classical_import_gate_v25"]["path"]).read_text())
    completion_atlas_v43 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v43"]["path"]).read_text())
    m1_preflight = json.loads((ROOT / data["authorities"]["strict_m1_common_snapshot_preflight"]["path"]).read_text())
    gate_v26 = json.loads((ROOT / data["authorities"]["classical_import_gate_v26"]["path"]).read_text())
    completion_atlas_v44 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v44"]["path"]).read_text())
    ...
    m1b_primal = json.loads((ROOT / data["authorities"]["strict_m1b_primal_composite_contraction"]["path"]).read_text())
    gate_v29 = json.loads((ROOT / data["authorities"]["classical_import_gate_v29"]["path"]).read_text())
    completion_atlas_v47 = json.loads((ROOT / data["authorities"]["lorentzian_weyl_bv_completion_atlas_v47"]["path"]).read_text())
    m1b_dual = json.loads((ROOT / data["authorities"]["strict_m1b_action_dual_lift"]["path"]).read_text())
    m1b_cyclic = json.loads((ROOT / data["authorities"]["strict_m1b_typed_cyclic_composite"]["path"]).read_text())
    ...
    require(claim_ids == {f"RF-{n:02d}-{suffix}" for n, suffix in [
        ...
        (62, "STRICT-WEYL-COMMON-SOURCE-Q2-ASSEMBLY"),
        (63, "STRICT-WEYL-COMMON-SOURCE-Q3-ASSEMBLY"),
        (64, "STRICT-WEYL-RESIDUAL-ZERO-MODE-PAYLOAD"),
        (65, "STRICT-WEYL-CENTERED-COHOMOLOGY-PAYLOAD"),
        (66, "STRICT-WEYL-RESIDUAL-SDR-TYPE-AND-LOCALITY-REPAIR"),
        (67, "STRICT-WEYL-COMMON-ENDPOINT-SDR-BINDING"),
        ...
        (72, "STRICT-WEYL-REPRESENTED-ACTION-SUPPORT-DUAL"),
    ...
    require(flags["strict_386_classical_import_gate_passed"] is True, "strict classical import Gate A verification missing")
    ...
    require(classical_diff_auxiliary["component_summary"] == {"families": 3, "ordered_field_coefficients": 168, "by_family": {"DIFF_C_F_HAT_F_HAT_STAR": 104, "DIFF_C_V_V_STAR": 32, "DIFF_C_ETA_ETA_STAR": 32}}, "classical Diff auxiliary component census drift")
    require(classical_diff_auxiliary["claim_flags"]["THREE_DIFF_AUXILIARY_FIELD_COMPONENT_TABLES_SERIALIZED"] is True and classical_diff_auxiliary["claim_flags"]["THREE_DIFF_AUXILIARY_BV_COTANGENT_LIFTS_SERIALIZED"] is False, "classical Diff source/receiver boundary drift")
    diff_summary = strict_diff_auxiliary["component_summary"]
    require((diff_summary["carrier_rows"], diff_summary["completed_families"], diff_summary["master_density_coefficients"], diff_summary["field_output_coefficients"], diff_summary["antifield_output_coefficients"], diff_summary["c_star_output_coefficients"], diff_summary["formal_variational_defects"], diff_summary["Koszul_symmetry_defects"]) == (386, 3, 264, 336, 632, 704, 0, 0), "strict Diff BV variational census drift")
    diff_complete = strict_diff_auxiliary["inventory_completeness"]
    require((diff_complete["known_required_cubic_block_families_enumerated"], diff_complete["component_coefficient_complete_families"], diff_complete["component_coefficient_open_families"]) == (7, 7, 0) and diff_complete["diffeomorphism_BV_representation_component_complete"] is True and diff_complete["exhaustive_full_nonlinear_BV_family_census"] is False and diff_complete["full_source_q2_q3_pullback_replayed"] is False, "strict Diff known-family/exhaustive boundary drift")
    ...
    require(shifted_mass_q2["shifted_mass_q2_lift"]["component_counts"] == {"q2_f_hat_f_hat_to_h_star": 120, "q2_h_f_hat_to_f_hat_star_with_Koszul_mates": 272, "total_ordered_q2_coefficients": 392}, "shifted-mass q2 component census drift")
    require(shifted_mass_q2["exact_replay"]["cyclicity_equalities_checked"] == 3000 and shifted_mass_q2["exact_replay"]["cyclicity_defects"] == 0 and shifted_mass_q2["claim_flags"]["FULL_SOURCE_Q2_ASSEMBLED"] is False, "shifted-mass q2 scoped cyclicity boundary drift")
    sign_repair = diff_auxiliary_v2["canonical_sign_repair"]
    require((sign_repair["translated_coefficients"], sign_repair["unrepaired_q1_q2_nonzero_coefficients"], sign_repair["repaired_q1_q2_nonzero_coefficients"], sign_repair["canonical_q2_cyclicity_defects"]) == (704, 336, 0, 0), "auxiliary c-star V2 repair drift")
    require(diff_auxiliary_v2["claim_flags"]["CANONICAL_C_STAR_TRANSLATION_APPLIED"] is True and diff_auxiliary_v2["claim_flags"]["FULL_SOURCE_Q2_COMMON_UNION_ASSEMBLED"] is False, "auxiliary c-star V2 scope firewall drift")
    require(source_q2["family_census"]["total_shifted_source_q2_families"] == 16 and source_q2["source_q2_snapshot"]["minimal_ordered_symbolic_components"] == 22 and source_q2["source_q2_snapshot"]["auxiliary_ordered_component_coefficients"] == 2064 and source_q2["source_q2_snapshot"]["auxiliary_component_collisions"] == 0, "common source-q2 census drift")
    require(source_q2["q1_q2_replay"]["graph_386_q1_q2_defects"] == 0 and source_q2["q2_cyclicity_replay"]["graph_386_q2_cyclicity_defects"] == 0 and source_q2["D_q2_replay"]["graph_D_q2_derivation_defects"] == 0, "common source-q2 identity replay drift")
    require(source_q2["claim_flags"]["FULL_SHIFTED_SOURCE_Q2_COMMON_UNION_ASSEMBLED"] is True and source_q2["claim_flags"]["FULL_SOURCE_Q3_ASSEMBLED"] is False and source_q2["claim_flags"]["CLASSICAL_IMPORT_GATE_PASSED"] is False, "common source-q2 q3/Gate firewall drift")
    require(gate_v14["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v14["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and gate_v14["required_hash_disposition"]["q2_hash"]["accepted"] == source_q2["source_q2_snapshot"]["sha256"], "Gate V14 accepted-q2/Gate-A boundary drift")
    require(gate_v14["claim_flags"]["STRICT_386_FULL_SOURCE_Q2_ASSEMBLED"] is True and gate_v14["claim_flags"]["STRICT_386_FULL_SOURCE_Q3_PULLBACK_REPLAYED"] is False and gate_v14["claim_flags"]["CLASSICAL_IMPORT_GATE_PASSED"] is False, "Gate V14 q2/q3 lifecycle firewall drift")
    require([item["route"] for item in completion_atlas_v32["route_selection"][:3]] == ["STRICT_AUXILIARY_Q3_COMMON_ASSEMBLY_AND_ARITY3_IDENTITIES", "STRICT_LAMBDA2_GENERAL_SOURCE_COCYCLE_CLOSURE", "STRICT_CANDIDATE_Q2_Q3_GREEN_LAMBDA2_RESPONSE"], "completion atlas V32 frontier ordering drift")
    require(completion_atlas_v32["claim_flags"]["strict_386_full_source_q2_assembled"] is True and completion_atlas_v32["claim_flags"]["strict_386_full_source_q3_pullback_replayed"] is False and completion_atlas_v32["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V32 q2/q3/Gate projection drift")
    quartic_vertex = classical_quartic_mass["shifted_auxiliary_quartic_mass_vertex"]
    quartic_replay = classical_quartic_mass["exact_replay"]
    require((quartic_vertex["possible_independent_symmetric_component_monomials"], quartic_vertex["nonzero_independent_component_monomials"], quartic_vertex["nonzero_ordered_fourth_variation_coefficients"]) == (3025, 321, 912), "classical shifted-mass quartic census drift")
    require((quartic_replay["pure_trace_second_variation_checks"], quartic_replay["mixed_conformal_recursion_checks"], quartic_replay["pure_trace_second_variation_defects"], quartic_replay["mixed_conformal_recursion_defects"]) == (55, 550, 0, 0), "classical quartic conformal replay drift")
    q3_counts = shifted_mass_q3["shifted_mass_q3_lift"]["component_counts"]
    require((q3_counts["q3_h_f_hat_f_hat_to_h_star_all_input_orders"], q3_counts["q3_h_h_f_hat_to_f_hat_star_all_input_orders"], q3_counts["total_ordered_q3_coefficients"]) == (2736, 3216, 5952), "shifted-mass q3 pairing-lift census drift")
    require((shifted_mass_q3["exact_replay"]["cyclicity_equalities_checked"], shifted_mass_q3["exact_replay"]["cyclicity_defects"], shifted_mass_q3["exact_replay"]["S3_input_symmetry_defects"]) == (40000, 0, 0), "shifted-mass q3 cyclicity replay drift")
    require(source_q3["family_census"]["total_source_q3_families"] == 2 and source_q3["family_census"]["source_q3_family_census_exhaustive"] is True and source_q3["source_q3_snapshot"]["auxiliary_ordered_component_coefficients"] == 5952, "common source-q3 family/census drift")
    require(source_q3["arity_three_replay"]["graph_386_arity_three_defects"] == 0 and source_q3["q3_cyclicity_replay"]["graph_386_q3_cyclicity_defects_mod_d"] == 0 and source_q3["D_q3_replay"]["graph_D_q3_derivation_defects"] == 0, "common source-q3 identity replay drift")
    require(gate_v15["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v15["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and len(gate_v15["minimal_missing_bundle"]) == 5 and gate_v15["m2_source_q3_assembly_resolution"]["accepted_q3_sha256"] == source_q3["source_q3_snapshot"]["sha256"], "Gate V15 q3/common-freeze boundary drift")
    require([item["route"] for item in completion_atlas_v33["route_selection"][:3]] == ["STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION", "STRICT_LAMBDA2_GENERAL_SOURCE_COCYCLE_CLOSURE", "STRICT_CANDIDATE_Q2_Q3_GREEN_LAMBDA2_RESPONSE"], "completion atlas V33 frontier ordering drift")
    require(completion_atlas_v33["claim_flags"]["strict_386_authoritative_full_q3_imported"] is True and completion_atlas_v33["claim_flags"]["strict_386_full_arity_three_identity_replayed"] is True and completion_atlas_v33["claim_flags"]["strict_386_q2_q3_green_compatibility_certified"] is False and completion_atlas_v33["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V33 q3/causal/Gate projection drift")
    require(len(residual_zero_modes["zero_mode_basis"]["canonical_generator_order"]) == 15 and len(residual_zero_modes["zero_mode_basis"]["canonical_dual_order"]) == 15, "residual primal/dual mode count drift")
    require(residual_zero_modes["so42_structure_constants"]["nonzero_entries"] == 120 and len(residual_zero_modes["residual_representation"]["matrices"]) == 15 and residual_zero_modes["residual_differential_q_res_0"]["degree_zero_unary_matrix"]["nonzero_entries"] == 0, "residual Lie/representation/q_res payload drift")
    require(all(value == 0 for value in residual_zero_modes["exact_replay"].values()) and residual_zero_modes["claim_flags"]["M5_RESIDUAL_EXACT_PAYLOAD_COMPLETE"] is True and residual_zero_modes["claim_flags"]["COMMON_GATE_A_FREEZE_BOUND"] is False, "residual exact replay/common-freeze boundary drift")
    require(gate_v16["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v16["gate_disposition"]["same_theory_receiver_verified_scoped"] == 15 and gate_v16["gate_disposition"]["freeze_checks_receiver_verified_scoped"] == 9 and gate_v16["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and len(gate_v16["minimal_missing_bundle"]) == 4, "Gate V16 M5/common-freeze boundary drift")
    require([item["route"] for item in completion_atlas_v34["route_selection"][:4]] == ["STRICT_CENTERED_H3_H4_H5_REPRESENTATIVE_PAYLOAD", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION", "STRICT_RESIDUAL_SDR_COMMON_CARRIER", "STRICT_FULL_CYCLIC_PAIRING"], "completion atlas V34 frontier ordering drift")
    require(completion_atlas_v34["claim_flags"]["strict_M5_residual_exact_payload_complete"] is True and completion_atlas_v34["claim_flags"]["strict_residual_zero_mode_hash_common_bound"] is False and completion_atlas_v34["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V34 residual/Gate projection drift")
    centered_dims = [centered["ordered_centered_cochain_basis"]["degrees"][str(degree)]["dimension"] for degree in (3, 4, 5)]
    require(centered_dims == [727, 3084, 8532], "centered C3/C4/C5 basis dimensions drift")
    require(centered["centered_differential_summary"]["aggregate_nonzero_coefficients"] == 85091 and centered["centered_differential_summary"]["aggregate_ranks_d3_d4"] == [636, 2446] and centered["centered_differential_summary"]["cohomology_dimension_H4"] == 2, "centered differential/rank/H4 census drift")
    require(all(value == 0 for key, value in centered["exact_replay"].items() if key.endswith("defects")) and centered["normalized_H4_representatives"]["normalized_gram"] == [[1, 0], [0, 1]] and centered["normalized_H4_representatives"]["parity_action_in_chiral_basis"] == [[0, 1], [1, 0]], "centered representative replay drift")
    require(centered["claim_flags"]["M6_CENTERED_REPRESENTATIVES_COMPLETE"] is True and centered["claim_flags"]["COMMON_GATE_A_FREEZE_BOUND"] is False, "centered M6/common-freeze boundary drift")
    require(gate_v17["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v17["gate_disposition"]["same_theory_receiver_verified_scoped"] == 17 and gate_v17["gate_disposition"]["freeze_checks_receiver_verified_scoped"] == 9 and gate_v17["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v17["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT", "M3_RESIDUAL_SDR", "M4_FULL_CYCLIC_PAIRING"], "Gate V17 M6/common-freeze boundary drift")
    require([item["route"] for item in completion_atlas_v35["route_selection"][:3]] == ["STRICT_RESIDUAL_SDR_COMMON_CARRIER", "STRICT_FULL_CYCLIC_PAIRING", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V35 frontier ordering drift")
    require(completion_atlas_v35["claim_flags"]["strict_M6_centered_representatives_complete"] is True and completion_atlas_v35["claim_flags"]["strict_representative_hash_common_bound"] is False and completion_atlas_v35["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V35 centered/Gate projection drift")
    type_census = residual_sdr_type_audit["type_census"]
    require(len(type_census["endpoint_row_ids"]) == 30 and type_census["dfinite_total_full_coordinates"] == 4490 and type_census["dfinite_total_residual_coordinates"] == 470 and type_census["zero_mode_generator_coordinates"] == 15 and type_census["zero_mode_dual_coordinates"] == 15, "residual SDR carrier census drift")
    require(residual_sdr_type_audit["claim_flags"]["STRICT_386_GRAPH_ENDPOINT_SDR_SUPPORT_LOCAL"] is True and residual_sdr_type_audit["claim_flags"]["DFINITE_RESIDUAL_PROJECTOR_SUPPORT_LOCAL"] is False and residual_sdr_type_audit["claim_flags"]["ZERO_MODE_PROJECTOR_SUPPORT_LOCAL"] is False and residual_sdr_type_audit["claim_flags"]["M3_TYPED_SPLIT_REQUIRED"] is True, "residual SDR locality/type boundary drift")
    require(gate_v18["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v18["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v18["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT", "M3L_COMMON_ENDPOINT_SDR_BINDING", "M3R_TYPED_RESIDUAL_COMPARISON", "M4_FULL_CYCLIC_PAIRING"], "Gate V18 typed M3 split drift")
    require([item["route"] for item in completion_atlas_v36["route_selection"][:4]] == ["STRICT_COMMON_ENDPOINT_SDR_BINDING", "STRICT_FULL_CYCLIC_PAIRING", "STRICT_ENDPOINT_TO_RESIDUAL_SPECTRAL_COMPARISON", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V36 frontier ordering drift")
    require(completion_atlas_v36["claim_flags"]["strict_M3_typed_split_required"] is True and completion_atlas_v36["claim_flags"]["strict_M3L_common_endpoint_sdr_bound"] is False and completion_atlas_v36["claim_flags"]["strict_M3R_typed_residual_comparison_constructed"] is False and completion_atlas_v36["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V36 typed residual/Gate boundary drift")
    require(endpoint_sdr_binding["common_manifest"]["carrier_rows"] == 386 and endpoint_sdr_binding["common_manifest"]["endpoint_rows"] == 30 and endpoint_sdr_binding["common_manifest"]["contracted_rows"] == 356 and len(endpoint_sdr_binding["common_manifest"]["artifact_pins"]) == 10 and len(endpoint_sdr_binding["common_manifest"]["object_hashes"]) == 17, "M3L common-manifest census drift")
    require(endpoint_sdr_binding["exact_replay"]["compatibility_links_checked"] == 15 and all(count == 0 for key, count in endpoint_sdr_binding["exact_replay"].items() if key.endswith("defects")), "M3L compatibility/identity replay drift")
    require(endpoint_sdr_binding["claim_flags"]["M3L_COMMON_ENDPOINT_SDR_BOUND"] is True and endpoint_sdr_binding["claim_flags"]["M3R_TYPED_RESIDUAL_COMPARISON_CONSTRUCTED"] is False and endpoint_sdr_binding["claim_flags"]["CLASSICAL_IMPORT_GATE_PASSED"] is False, "M3L scope/Gate firewall drift")
    require(gate_v19["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v19["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v19["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT", "M3R_TYPED_RESIDUAL_COMPARISON", "M4_FULL_CYCLIC_PAIRING"], "Gate V19 M3L integration drift")
    require([item["route"] for item in completion_atlas_v37["route_selection"][:3]] == ["STRICT_FULL_CYCLIC_PAIRING", "STRICT_ENDPOINT_TO_RESIDUAL_SPECTRAL_COMPARISON", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V37 frontier ordering drift")
    require(completion_atlas_v37["claim_flags"]["strict_M3L_common_endpoint_sdr_bound"] is True and completion_atlas_v37["claim_flags"]["strict_M3R_typed_residual_comparison_constructed"] is False and completion_atlas_v37["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V37 M3L/residual/Gate boundary drift")
    pairing = local_cyclic_pairing["pairing_replay"]
    cyclicity = local_cyclic_pairing["local_cyclicity_replay"]
    require((pairing["carrier_rows"], pairing["endpoint_rows"], pairing["auxiliary_rows"], pairing["mapping_cone_and_cotangent_rows"], pairing["nonzero_ordered_pairing_entries"], pairing["exact_rational_rank"], pairing["rows_with_nonzero_partner"]) == (386, 30, 36, 320, 410, 386, 386), "M4L local pairing census/rank drift")
    require(all(value == 0 for key, value in cyclicity.items() if key.endswith("defects")) and cyclicity["q2_cyclicity_equalities_checked"] == 3264 and cyclicity["q3_cyclicity_equalities_checked"] == 40000 and cyclicity["D_formal_skew_adjoint_pairing_entries_checked"] == 410, "M4L local cyclicity replay drift")
    require(local_cyclic_pairing["claim_flags"]["M4L_LOCAL_GRAPH_CYCLIC_PAIRING_COMPLETE"] is True and local_cyclic_pairing["claim_flags"]["M4R_TYPED_RESIDUAL_CYCLICITY_COMPLETE"] is False and local_cyclic_pairing["claim_flags"]["FULL_RESIDUAL_CYCLIC_PAIRING_CERTIFIED"] is False, "M4L/M4R type boundary drift")
    require(gate_v20["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v20["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v20["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT", "M3R_TYPED_RESIDUAL_COMPARISON", "M4R_TYPED_RESIDUAL_CYCLICITY"], "Gate V20 typed M4 integration drift")
    require([item["route"] for item in completion_atlas_v38["route_selection"][:3]] == ["STRICT_ENDPOINT_TO_RESIDUAL_SPECTRAL_COMPARISON", "STRICT_TYPED_RESIDUAL_CYCLICITY", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V38 frontier ordering drift")
    require(completion_atlas_v38["claim_flags"]["strict_M4L_local_graph_cyclic_pairing_complete"] is True and completion_atlas_v38["claim_flags"]["strict_M4R_typed_residual_cyclicity_complete"] is False and completion_atlas_v38["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V38 M4L/M4R/Gate boundary drift")
    require(residual_comparison["comparison"]["source"]["total_dimension"] == 4080 and residual_comparison["comparison"]["target"]["dimension"] == 470 and len(residual_comparison["ordered_residual_basis"]) == 470, "M3R comparison carrier census drift")
    require(residual_comparison["exact_replay"]["ordered_crosswalk_defects"] == 0 and residual_comparison["exact_replay"]["dfinite_pi_iota_identity_defects"] == 0 and residual_comparison["exact_replay"]["dfinite_q0_iota_chain_defects"] == 0 and residual_comparison["exact_replay"]["dfinite_pi_q0_chain_defects"] == 0, "M3R exact comparison replay drift")
    require(gate_v21["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v21["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v21["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT", "M4R_TYPED_RESIDUAL_CYCLICITY"], "Gate V21 M3R integration drift")
    require([item["route"] for item in completion_atlas_v39["route_selection"][:2]] == ["STRICT_TYPED_RESIDUAL_CYCLICITY", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V39 frontier ordering drift")
    obstruction = residual_cyclic_obstruction["obstruction_replay"]
    preflight = residual_cyclic_obstruction["cotangent_preflight"]
    even_control = residual_cyclic_obstruction["older_even_form_control"]
    require((obstruction["m3r_residual_coordinates"], obstruction["pulled_back_odd_pairing_nonzeros"], obstruction["pulled_back_odd_pairing_rank"], obstruction["pulled_back_odd_pairing_nullity"], obstruction["nondegeneracy_rank_defect"]) == (470, 0, 0, 470, 470), "current M3R residual odd-pairing obstruction drift")
    require((preflight["primal_dimension"], preflight["adjoined_dual_dimension"], preflight["total_dimension"], preflight["nonzero_ordered_pairing_entries"], preflight["constructive_exact_rank"]) == (470, 470, 940, 940, 940), "M3RC cotangent preflight census/rank drift")
    require(preflight["odd_skew_defects"] == 0 and preflight["pairing_degree_defects"] == 0 and preflight["q_res_cyclicity_defects"] == 0 and even_control["dimension"] == 268 and even_control["field_theoretic_BV_antibracket_identified"] is False, "M3RC preflight/even-form boundary drift")
    ...
    support_dual = m3rc_action_support["support_dual_identification"]
    action_pairing = m3rc_action_support["action_pairing_identification"]
    m3rc_replay = m3rc_action_support["exact_replay"]
    require(m3rc_action_support["scope"]["energies"] == [2, 3, 4, 5, 6], "M3RC-B represented energy scope drift")
    require((support_dual["compact_source_representatives"], support_dual["compact_source_support_defects"], support_dual["causal_recovery_defects"], support_dual["support_exact_sequence_defects"]) == (470, 0, 0, 0), "M3RC-B compact-source dual replay drift")
    require((action_pairing["positive_frequency_dimension"], action_pairing["negative_frequency_dual_dimension"], action_pairing["phase_space_dimension"], action_pairing["phase_pairing_rank"], action_pairing["formal_cotangent_pairing_rank"]) == (470, 470, 940, 940, 940), "M3RC-B action-pairing census/rank drift")
    require(action_pairing["positive_krein_inertia"] == {"negative": 240, "positive": 230, "zero": 0} and action_pairing["pairing_identification_defects"] == 0 and action_pairing["basis_crosswalk_defects"] == 0, "M3RC-B inertia/pairing replay drift")
    require(m3rc_replay["formal_duals"] == 470 and m3rc_replay["compact_source_classes"] == 470 and all(value == 0 for key, value in m3rc_replay.items() if key.endswith("defects")), "M3RC-B exact replay drift")
    require(m3rc_action_support["claim_flags"]["M3RC_B_REPRESENTED_ACTION_SUPPORT_DUAL_IDENTIFICATION_COMPLETE"] is True and m3rc_action_support["claim_flags"]["FULL_ALL_ENERGY_CONTINUOUS_DUAL_IDENTIFIED"] is False and m3rc_action_support["claim_flags"]["FORMAL_8980_SOURCE_IS_AUTHORITATIVE_ORIGINAL_BV_COMPLEX"] is False, "M3RC-B represented/full authority firewall drift")
    require(gate_v24["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v24["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and [item["id"] for item in gate_v24["minimal_missing_bundle"]] == ["M4R_TYPED_RESIDUAL_CYCLICITY", "M1_COMMON_STRICT_SNAPSHOT"], "Gate V24 M3RC-B integration drift")
    require([item["route"] for item in completion_atlas_v42["route_selection"][:2]] == ["STRICT_TYPED_RESIDUAL_CYCLICITY", "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION"], "completion atlas V42 frontier ordering drift")
    require(completion_atlas_v42["claim_flags"]["strict_M3RC_B_represented_action_support_dual_identification_complete"] is True and completion_atlas_v42["claim_flags"]["strict_M4R_typed_residual_cyclicity_ready"] is True and completion_atlas_v42["claim_flags"]["strict_full_all_energy_continuous_dual_identified"] is False and completion_atlas_v42["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V42 M3RC-B/Gate boundary drift")
    typed_carrier = typed_residual_cyclicity["typed_carrier"]
    cyclic_replay = typed_residual_cyclicity["exact_cyclic_replay"]
    require(typed_residual_cyclicity["scope"]["energies"] == [2, 3, 4, 5, 6] and len(cyclic_replay["block_replays"]) == 5, "M4R represented block scope drift")
    require((typed_carrier["primal_residual_coordinates"], typed_carrier["compact_source_dual_coordinates"], typed_carrier["total_residual_coordinates"], typed_carrier["action_pairing_rank"], typed_carrier["formal_source_coordinates"]) == (470, 470, 940, 940, 8980), "M4R typed carrier census/rank drift")
    require(cyclic_replay["formal_source_dimension"] == 8980 and cyclic_replay["residual_dimension"] == 940 and cyclic_replay["residual_pairing_rank"] == 940 and cyclic_replay["all_identity_defects"] == 0 and all(block["total_identity_defects"] == 0 for block in cyclic_replay["block_replays"]), "M4R exact cyclic replay drift")
    require(typed_residual_cyclicity["claim_flags"]["M4R_TYPED_RESIDUAL_CYCLICITY_COMPLETE"] is True and typed_residual_cyclicity["claim_flags"]["M1_COMMON_STRICT_SNAPSHOT_COMPLETE"] is False and typed_residual_cyclicity["claim_flags"]["FORMAL_8980_SOURCE_IS_AUTHORITATIVE_ORIGINAL_BV_COMPLEX"] is False, "M4R/M1/full-source authority firewall drift")
    require(gate_v25["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v25["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and gate_v25["gate_disposition"]["exports_total"] == 20 and gate_v25["gate_disposition"]["freeze_checks_total"] == 10 and [item["id"] for item in gate_v25["minimal_missing_bundle"]] == ["M1_COMMON_STRICT_SNAPSHOT"], "Gate V25 M4R/M1 integration drift")
    require(completion_atlas_v43["route_selection"][0]["route"] == "STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION" and completion_atlas_v43["claim_flags"]["strict_M4R_typed_residual_cyclicity_complete"] is True and completion_atlas_v43["claim_flags"]["strict_M1_common_strict_snapshot_complete"] is False and completion_atlas_v43["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V43 M4R/M1/Gate boundary drift")
    require(m1_preflight["counts"] == {"exports_total": 20, "exports_common_object_ready": 14, "exports_blocked_full_typed_ledger": 2, "exports_blocked_composite_contraction": 4, "hashes_total": 7, "hash_objects_ready_await_binding": 4, "hashes_blocked_before_binding": 3, "freeze_checks_total": 10, "freeze_checks_common_snapshot_replayed": 0}, "M1 preflight blocker census drift")
    require([row["id"] for row in m1_preflight["m1_work_packages"]] == ["M1A_FULL_TYPED_CARRIER_LEDGER", "M1B_REPRESENTED_COMPOSITE_CONTRACTION", "M1C_COMMON_MANIFEST_REPLAY"] and m1_preflight["claim_flags"]["M1_COMMON_STRICT_SNAPSHOT_COMPLETE"] is False, "M1 package order/lifecycle drift")
    require(m1_preflight["authoritative_source_decision"]["formal_8980_source_authoritative"] is False and m1_preflight["authoritative_source_decision"]["local_source"] == "LOCAL_GRAPH_BV_386", "M1 authoritative-source firewall drift")
    require(gate_v26["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v26["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and gate_v26["claim_flags"]["M1_PREFLIGHT_COMPLETE"] is True and gate_v26["claim_flags"]["M1_COMMON_STRICT_SNAPSHOT_COMPLETE"] is False, "Gate V26 M1 preflight boundary drift")
    require([row["route"] for row in completion_atlas_v44["route_selection"][:3]] == ["STRICT_M1A_FULL_TYPED_CARRIER_LEDGER", "STRICT_M1B_REPRESENTED_COMPOSITE_CONTRACTION", "STRICT_M1C_COMMON_MANIFEST_REPLAY"] and completion_atlas_v44["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V44 M1 route/Gate boundary drift")
    require(m1a_local["counts"] == {"extension_rows": 356, "auxiliary_rows_fully_namespaced": 36, "mapping_cone_rows_fully_namespaced": 320, "mapping_cone_rows_with_not_applicable_scalar_Weyl_weight": 320, "rows_with_unresolved_fields": 0, "local_386_rows_fully_namespaced_after_this_result": 386, "local_386_rows_remaining_partial": 0}, "M1A2 local coverage drift")
    require(m1a_local["cotton_nonlinear_weyl_non_eigen_witness"]["infinitesimal_formula_in_dimension_four"] == "delta_omega V_abc=omega^p W_apbc" and m1a_local["cotton_nonlinear_weyl_non_eigen_witness"]["component_checks"] == 2560 and m1a_local["cotton_nonlinear_weyl_non_eigen_witness"]["defects"] == 0 and m1a_local["cotton_nonlinear_weyl_non_eigen_witness"]["nonzero_mixing_checks"] == 176, "M1A2 Cotton non-eigenrow witness drift")
    ...
    require(m1b_primal["represented_contraction"]["aggregate"] == {"represented_rows": 4080, "residual_rows": 470, "q0_nonzero_entries": 1805, "iota_nonzero_entries": 470, "pi_nonzero_entries": 470, "homotopy_nonzero_entries": 1805, "q0_cross_partition_defects": 0}, "M1B primal represented contraction census drift")
    require(all(value == 0 for value in m1b_primal["represented_contraction"]["exact_replay"].values()) and all(value == 0 for value in m1b_primal["formal_composition_replay"].values()), "M1B primal exact/formal replay drift")
    require(m1b_primal["claim_flags"]["M1B_PRIMAL_COMPOSITE_CONTRACTION_COMPLETE"] is True and m1b_primal["claim_flags"]["GRAPH_TO_ENDPOINT_FACTOR_SUPPORT_LOCAL"] is True and m1b_primal["claim_flags"]["HARMONIC_RESTRICTION_SUPPORT_LOCAL"] is False and m1b_primal["claim_flags"]["RAW_386_BY_470_COMPONENT_MATRIX_CONSTRUCTED"] is False and m1b_primal["claim_flags"]["M1B_ACTION_DUAL_LIFT_COMPLETE"] is False and m1b_primal["claim_flags"]["M1B_TYPED_CYCLIC_REPLAY_COMPLETE"] is False and m1b_primal["claim_flags"]["M1B_REPRESENTED_COMPOSITE_CONTRACTION_COMPLETE"] is False, "M1B primal lifecycle/support firewall drift")
    require(gate_v29["gate_disposition"]["gate_a_status"] == "FAIL_CLOSED" and gate_v29["gate_disposition"]["accepted_common_snapshot_hashes"] == 1 and gate_v29["m1b_primal_completion_resolution"]["M1B_primal_complete"] is True and gate_v29["m1b_primal_completion_resolution"]["M1B_complete"] is False, "Gate V29 M1B boundary drift")
    require([row["route"] for row in completion_atlas_v47["route_selection"][:3]] == ["STRICT_M1B_ACTION_DUAL_LIFT", "STRICT_M1B_TYPED_CYCLIC_REPLAY", "STRICT_M1C_COMMON_MANIFEST_REPLAY"] and completion_atlas_v47["claim_flags"]["strict_M1B_primal_composite_contraction_complete"] is True and completion_atlas_v47["claim_flags"]["strict_pure_weyl_classical_gate_passed"] is False, "completion atlas V47 M1B route/Gate boundary drift")
    require(m1b_dual["claim_flags"]["M1B_ACTION_DUAL_LIFT_COMPLETE"] is True and m1b_dual["claim_flags"]["ALL_470_RESIDUAL_DUALS_ACTION_DERIVED_COMPACT_SOURCE"] is True and m1b_dual["claim_flags"]["FULL_4080_ALGEBRAIC_DUAL_COMPACT_SOURCE_IDENTIFIED"] is False and sum(m1b_dual["represented_dual_lift"]["exact_replay"].values()) == 0, "M1B action-dual exact/scope drift")
    require(m1b_cyclic["claim_flags"]["M1B_REPRESENTED_COMPOSITE_CONTRACTION_COMPLETE"] is True and m1b_cyclic["claim_flags"]["ACTION_RESIDUAL_PAIRING_RANK_940"] is True and m1b_cyclic["claim_flags"]["FINITE_8160_CHECK_CORE_IS_AUTHORITATIVE_FULL_BV_SOURCE"] is False and len(m1b_cyclic["exact_cyclic_replay"]["identity_totals"]) == 13 and sum(m1b_cyclic["exact_cyclic_replay"]["identity_totals"].values()) == 0, "M1B typed cyclic replay drift")
    ...
    require(flags["strict_386_full_cotangent_lift_serialized"] is True and flags["strict_386_full_quadratic_bv_cotangent_lift_serialized"] is True and flags["strict_386_full_source_q2_q3_pullback_replayed"] is True and flags["strict_386_full_source_q2_pullback_replayed"] is True and flags["strict_386_full_source_q3_pullback_replayed"] is True and flags["classical_import_gate_v9_fail_closed"] is True, "paper quadratic-lift/full-pullback completion drift")
    ...
    require(flags["strict_386_exhaustive_full_nonlinear_bv_family_census"] is True and flags["strict_nonlinear_weyl_boost_ghost_manifest_complete"] is True and flags["strict_386_full_source_q2_assembled"] is True and flags["strict_386_diff_c_star_v2_repair_certified"] is True and flags["strict_386_source_q2_common_hash_accepted"] is True and flags["strict_386_full_q1_q2_identity_replayed"] is True and flags["strict_386_full_q2_cyclicity_replayed"] is True and flags["strict_386_full_d_q2_derivation_replayed"] is True and flags["strict_386_hh_hv_bv_cotangent_lift_component_complete"] is True and flags["strict_386_diff_bv_representation_component_complete"] is True and flags["strict_386_seven_known_required_cubic_families_component_complete"] is True and flags["classical_import_gate_v10_fail_closed"] is True and flags["classical_import_gate_v11_fail_closed"] is True and flags["classical_import_gate_v12_fail_closed"] is True and flags["classical_import_gate_v13_fail_closed"] is True and flags["classical_import_gate_v14_fail_closed"] is True and flags["classical_import_gate_v15_fail_closed"] is True and flags["classical_import_gate_v16_fail_closed"] is True and flags["classical_import_gate_v17_fail_closed"] is True and flags["classical_import_gate_v18_fail_closed"] is True and flags["classical_import_gate_v19_fail_closed"] is True and flags["classical_import_gate_v20_fail_closed"] is True and flags["classical_import_gate_v21_fail_closed"] is True, "paper Gate V21 source-q2/q3/residual/centered/type firewall drift")
    require(flags["strict_residual_zero_mode_payload_serialized"] is True and flags["strict_residual_zero_mode_identities_replayed"] is True and flags["strict_m5_residual_exact_payload_complete"] is True and flags["strict_residual_zero_mode_hash_common_bound"] is True, "paper residual payload/common-freeze flags drift")
    require(flags["strict_centered_c3_c4_c5_bases_serialized"] is True and flags["strict_centered_differential_reconstructed"] is True and flags["strict_normalized_weyl_square_representatives_serialized"] is True and flags["strict_centered_h4_cohomology_replayed"] is True and flags["strict_m6_centered_representatives_complete"] is True and flags["strict_representative_hash_common_bound"] is True, "paper centered M6/common-freeze flags drift")
    require(flags["strict_residual_sdr_type_audit_complete"] is True and flags["strict_graph_endpoint_sdr_support_local"] is True and flags["strict_dfinite_residual_projector_support_local"] is False and flags["strict_zero_mode_projector_support_local"] is False and flags["strict_m3_typed_split_required"] is True and flags["strict_386_common_endpoint_sdr_manifest_bound"] is True and flags["strict_386_common_endpoint_sdr_identities_replayed"] is True and flags["strict_386_q1_d_q2_q3_same_local_carrier"] is True and flags["strict_m3l_common_endpoint_sdr_bound"] is True and flags["strict_m3r_typed_residual_comparison_constructed"] is True, "paper residual SDR type/locality/M3L/M3R flags drift")
    require(flags["strict_386_full_local_odd_pairing_nondegenerate"] is True and flags["strict_386_local_q1_sdr_d_q2_q3_cyclicity_complete"] is True and flags["strict_m4l_local_graph_cyclic_pairing_complete"] is True and flags["strict_m4r_typed_residual_cyclicity_complete"] is True and flags["strict_represented_residual_cyclic_pairing_certified"] is True and flags["strict_full_residual_cyclic_pairing_certified"] is False, "paper represented/full M4R flags drift")
    ...
    require(flags["bt_torus_top_band_flow_certified"] is True, "BT torus top-band flow flag is not certified")
    ...
    require(flags["bt_torus_sharp_virial_density_gate_certified"] is True, "BT sharp-virial density-gate flag is not certified")
    ...
    require(flags["bt_torus_quadratic_virial_density_gate_certified"] is True, "BT quadratic virial-density flag is not certified")
    ...
    require(atlas["bt_top_band_error_square"] == bt_top_band["refined_error_theorem"]["edge_error_square"] == "sum_e epsilon_e^2<=7*q^2*W^2*F+6*q^3*N", "BT top-band error bound drift")
    require(atlas["bt_top_band_hypothesis"] == bt_top_band["top_band_theorem"]["hypothesis"] == "W^2>=256*q^3*D^2*N*F", "BT top-band hypothesis drift")
    require(atlas["bt_top_band_cutoff"] == bt_top_band["four_torus_dichotomy"]["torus_sufficient_condition"] == "W>=3072*L^(11/3)", "BT top-band contrast cutoff drift")
    require(atlas["bt_top_band_normalized_floor"] == bt_top_band["four_torus_dichotomy"]["normalized_conclusion"] == "Q/omega_L^2>=32/pi^4", "BT top-band normalized floor drift")
    ...
    require(atlas["bt_sharp_virial_fixed_margin_theorem"] == bt_sharp_virial["four_torus_theorem"]["fixed_margin_theorem"] == "for every 0<epsilon<=32, A>=(32+epsilon)*L^4 implies Q/omega_L^2>=epsilon^2/(8192*pi^4)", "BT sharp-virial fixed-margin theorem drift")
    require(atlas["bt_sharp_virial_collapsing_action_necessity"] == bt_sharp_virial["four_torus_theorem"]["collapsing_action_necessity"] == "Q/omega_L^2->0 implies limsup A/L^4<=32", "BT sharp-virial collapsing action necessity drift")
    require(atlas["bt_sharp_virial_collapsing_contrast_necessity"] == bt_sharp_virial["four_torus_theorem"]["collapsing_contrast_necessity"] == "Q/omega_L^2->0 implies limsup W/L^2<=8", "BT sharp-virial collapsing contrast necessity drift")
    ...
    require(atlas["bt_quadratic_virial_fixed_margin_theorem"] == bt_quadratic_virial["four_torus_theorem"]["fixed_margin_theorem"] == "for every 0<epsilon<=32, A>=(272/29+epsilon)*L^4 implies Q/omega_L^2>=841*epsilon^2/(8388608*pi^4)", "BT quadratic-virial fixed-margin theorem drift")
    require(atlas["bt_quadratic_virial_collapsing_action_necessity"] == bt_quadratic_virial["four_torus_theorem"]["collapsing_action_necessity"] == "Q/omega_L^2->0 implies limsup A/L^4<=272/29", "BT quadratic-virial collapsing action necessity drift")
    require(atlas["bt_quadratic_virial_collapsing_contrast_necessity"] == bt_quadratic_virial["four_torus_theorem"]["collapsing_contrast_necessity"] == "Q/omega_L^2->0 implies limsup W^2/L^4<=544/29", "BT quadratic-virial collapsing contrast necessity drift")
    ...
    for phrase in [
        ...
        r"At the arity-two checkpoint",
        r"STRICT_386_SOURCE_Q2_COMMON_ASSEMBLY_V1",
        r"CLASSICAL_IMPORT_GATE_V14_RECONCILIATION",
        r"metric-dependent auxiliary",
        r"STRICT_AUXILIARY_Q3_COMMON_ASSEMBLY_AND_ARITY3_IDENTITIES",
        r"CLASSICAL_SHIFTED_AUXILIARY_QUARTIC_MASS_V1",
        r"STRICT_386_SHIFTED_MASS_BV_Q3_LIFT_V1",
        r"STRICT_386_SOURCE_Q3_COMMON_ASSEMBLY_V1",
        r"CLASSICAL_IMPORT_GATE_V15_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V33",
        r"STRICT_RESIDUAL_SDR_TYPE_AND_LOCALITY_AUDIT_V1",
        r"CLASSICAL_IMPORT_GATE_V18_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V36",
        r"STRICT_386_COMMON_ENDPOINT_SDR_BINDING_V1",
        r"CLASSICAL_IMPORT_GATE_V19_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V37",
        r"STRICT_386_LOCAL_CYCLIC_PAIRING_CLOSURE_V1",
        r"CLASSICAL_IMPORT_GATE_V20_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V38",
        r"exact rank-386 odd pairing with 410",
        r"M4L",
        r"M4R",
        r"STRICT_RESIDUAL_CYCLIC_CARRIER_OBSTRUCTION_V1",
        r"\operatorname{rank}=0",
        r"\operatorname{nullity}=470",
        r"940-coordinate carrier",
        r"Gate V22",
        r"M3RC",
        ...
        r"STRICT_M3RC_ACTION_SUPPORT_DUAL_IDENTIFICATION_V1",
        r"470 compact-source",
        r"pre-suspension Krein inertia",
        r"CLASSICAL_IMPORT_GATE_V24_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V42",
        r"STRICT_TYPED_RESIDUAL_CYCLICITY_V1",
        r"projection equals the adjoint of inclusion",
        r"homotopy is skew-adjoint",
        r"CLASSICAL_IMPORT_GATE_V25_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V43",
        r"STRICT_M1A_LOCAL_SEMANTIC_EXTENSION_V1",
        ...
        r"STRICT_M1B_PRIMAL_COMPOSITE_CONTRACTION_V1",
        r"CLASSICAL_IMPORT_GATE_V29_RECONCILIATION",
        r"FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V47",
        r"STRICT_M1B_ACTION_DUAL_LIFT_V1",
        ...
        r"M3L common endpoint-SDR binding",
        r"M3R typed endpoint-to-residual spectral comparison",
        r"5,952 ordered auxiliary",
        r"40,000 pointwise cyclic",
        r"605 exact conformal Ward",
        r"STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION",
        r"1,392 nonzero hh",
