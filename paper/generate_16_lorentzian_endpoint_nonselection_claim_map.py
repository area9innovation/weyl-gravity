...
AUTHORITIES = {
    ...
    "complete_massive_axial_jost": "black_hole_programme/phase4/axial_massive_jost_crosswalk_v1/certificate.json",
    ...
    return {
        ...
        "exact_identities": {
            ...
            "complete_massive_axial_first_jet": {
                ...
                "parameter_domain": "omega != 0",
                "all_order_differentiated_Jost_map_certified": True,
                "opposite_Jost_admixture_excluded": True,
                "physical_massive_QNM_velocity": "2*I*kappa/(3*omega)",
                "physical_massive_QNM_velocity_nonzero": True,
            },
        ...
        "certified_scope": {
            ...
            "physical_massive_qnm_slope": True,
...
def coverage(claim_sha: str) -> dict:
    claims = [
        ...
        (
            ...
            "The Bach cocycle has an exact regular redshift representative, the complete coupled axial first jet obeys [I_Bach]=(3 i omega/2)[I_phys], and matrix Frobenius/Volterra endpoint planes give the nonzero signed squared-mass QNM velocity 2 i kappa/(3 omega). Independently, the incoming Krein fibers admit a compact-band spectral fundamental symmetry with omega, omega, omega-cubed threshold weights.",
            "REDUCED-MODE",
        ),
        (
