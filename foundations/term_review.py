...
<noscript><p>The explained terms above and their full entries below work without JavaScript. Download the <a href="term-candidates-all.json.gz">complete index with source contexts</a> to browse the automatic extraction offline.</p></noscript>
