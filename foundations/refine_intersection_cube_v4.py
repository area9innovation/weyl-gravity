...
def build()->dict[str,Any]:
    ...
    for source in old["cells"]:
        ...
        if a or o:cell["coded_wave_revision"]={"frontier":frontier["result_id"],"status_change":bool(a),"evidence_overlay":bool(o),"previous_status":source["status"]}
        cells.append(cell)
