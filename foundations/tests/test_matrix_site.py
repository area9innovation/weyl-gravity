...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V34 report", app)
        ...
        self.assertIn("Read Gate V16 reconciliation", app)
        ...
        self.assertTrue(site_data["completion_atlas"]["strict_gate_v16_reconciliation"]["M5_payload_complete"])
        self.assertFalse(site_data["completion_atlas"]["strict_gate_v16_reconciliation"]["zero_mode_hash_common_bound"])
        ...
        self.assertEqual(site_data["completion_atlas"]["strict_gate_v16_reconciliation"]["accepted_top_level_hashes"], 1)
        ...
        self.assertEqual(site_data["completion_atlas"]["route_selection"][0]["route"], "STRICT_CENTERED_H3_H4_H5_REPRESENTATIVE_PAYLOAD")
