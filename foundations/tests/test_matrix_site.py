...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V16 report", app)
        self.assertIn("Read Gate V6 reconciliation", app)
        ...
        self.assertTrue((ROOT / "foundations/site/sources/quantum-weyl/classical_import/certificates/CLASSICAL_IMPORT_GATE_V6_RECONCILIATION.json").is_file())
        ...
        self.assertTrue((ROOT / "foundations/site/sources/quantum-weyl/classical_import/REPORT_GATE_V6.md").is_file())
