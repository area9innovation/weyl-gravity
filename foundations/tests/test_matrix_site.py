...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V30 report", app)
        ...
        self.assertIn("Read Gate V12 reconciliation", app)
        ...
        self.assertFalse(site_data["completion_atlas"]["strict_gate_v12_reconciliation"]["complete_source_q2_q3_pullback_replayed"])
        self.assertTrue(site_data["completion_atlas"]["claim_flags"]["strict_386_diff_bv_representation_component_complete"])
        self.assertFalse(site_data["completion_atlas"]["claim_flags"]["strict_386_exhaustive_full_nonlinear_bv_family_census"])
