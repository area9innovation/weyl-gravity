...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V35 report", app)
        ...
        self.assertIn("Read Gate V17 reconciliation", app)
        ...
        self.assertTrue(site_data["completion_atlas"]["strict_gate_v17_reconciliation"]["M5_payload_complete"])
        self.assertTrue(site_data["completion_atlas"]["strict_gate_v17_reconciliation"]["M6_payload_complete"])
        self.assertFalse(site_data["completion_atlas"]["strict_gate_v17_reconciliation"]["representative_hash_common_bound"])
        ...
        self.assertEqual(site_data["completion_atlas"]["strict_gate_v17_reconciliation"]["accepted_top_level_hashes"], 1)
        ...
        self.assertEqual(site_data["completion_atlas"]["route_selection"][0]["route"], "STRICT_RESIDUAL_SDR_COMMON_CARRIER")
