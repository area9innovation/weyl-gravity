...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V31 report", app)
        ...
        self.assertIn("Read Gate V13 reconciliation", app)
        ...
        self.assertFalse(site_data["completion_atlas"]["strict_gate_v13_reconciliation"]["full_source_q2_assembled"])
        ...
        self.assertFalse(site_data["completion_atlas"]["claim_flags"]["strict_386_full_source_q2_assembled"])
