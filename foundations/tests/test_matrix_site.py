...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V33 report", app)
        ...
        self.assertIn("Read Gate V15 reconciliation", app)
        ...
        self.assertTrue(site_data["completion_atlas"]["strict_gate_v15_reconciliation"]["full_source_q2_assembled"])
        self.assertTrue(site_data["completion_atlas"]["strict_gate_v15_reconciliation"]["full_source_q3_assembled"])
        ...
        self.assertEqual(site_data["completion_atlas"]["strict_gate_v15_reconciliation"]["accepted_top_level_hashes"], 1)
