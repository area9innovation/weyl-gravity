...
class MatrixSiteTests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        ...
        self.assertIn("Read the audited V29 report", app)
        ...
        self.assertIn("Read Gate V11 reconciliation", app)
        ...
        self.assertFalse(site_data["completion_atlas"]["strict_gate_v11_reconciliation"]["complete_source_q2_q3_pullback_replayed"])
