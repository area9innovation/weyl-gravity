...
SOURCE = ROOT / "foundations/build_lorentzian_weyl_bv_completion_atlas_v41.py"
CHECKER = ROOT / "foundations/check_lorentzian_weyl_bv_completion_atlas_v41.py"
...
SCHEMA = ROOT / "foundations/schema/foundational-lorentzian-weyl-bv-completion-atlas-v41.schema.json"
...
producer = load(SOURCE, "lorentzian_weyl_bv_completion_atlas_v41_source")
checker = load(CHECKER, "lorentzian_weyl_bv_completion_atlas_v41_checker")


class LorentzianWeylBVCompletionAtlasV41Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_m3rc_b_is_first_route(self):
        self.assertEqual(len(self.value["route_selection"]), 9)
        self.assertEqual(self.value["route_selection"][0]["route"], "STRICT_M3RC_ACTION_SUPPORT_DUAL_IDENTIFICATION")
    ...
    def test_formal_comparison_mutation_fails(self):
        value = copy.deepcopy(self.value)
        value["strict_dfinite_cotangent_dual_comparison"]["original_source_H1_dimension"] = 470
