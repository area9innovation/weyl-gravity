...
class MatrixSiteV2Tests(unittest.TestCase):
    ...
    def test_static_shell_exposes_migration_review(self):
        html = (ROOT / "foundations/site-v2/index.html").read_text()
        app = (ROOT / "foundations/site-v2/app-v2.js").read_text()
        css = (ROOT / "foundations/site-v2/styles.css").read_text()
        self.assertNotIn("https://", html)
        self.assertIn('<script src="app-v2.js"></script>', html)
        ...
        manifest = json.loads((ROOT / "foundations/site-v2/manifest.json").read_text())
        self.assertGreaterEqual(len(manifest["outputs"]), 38)
        self.assertTrue((ROOT / "foundations/site-v2/sources/foundations/results/FOUNDATIONAL_INTERSECTION_CUBE_V2.json").is_file())
        self.assertTrue((ROOT / "foundations/site-v2/sources/foundations/results/FOUNDATIONAL_INTERSECTION_CUBE_MIGRATION_AUDIT_V2.json").is_file())
