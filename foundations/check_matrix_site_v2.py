...
COMPLETION_ATLAS = ROOT / "foundations/results/FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V33.json"
...
COMPLETION_GATE_V15 = ROOT / "quantum-weyl/classical_import/certificates/CLASSICAL_IMPORT_GATE_V15_RECONCILIATION.json"
...
def check(data: dict[str, Any] | None = None) -> tuple[list[str], dict[str, Any]]:
    ...
    if completion.get("result_id") != "FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V33":
    ...
    if route_names[:3] != ["STRICT_COMMON_FREEZE_SNAPSHOT_AND_FINAL_CYCLIC_CONTRACTION", "STRICT_LAMBDA2_GENERAL_SOURCE_COCYCLE_CLOSURE", "STRICT_CANDIDATE_Q2_Q3_GREEN_LAMBDA2_RESPONSE"]:
        errors.append("strict V33 common-freeze route frontier")
    ...
    gate_v15 = completion.get("strict_gate_v15_reconciliation", {})
    if (
        gate_v15.get("result_id") != gate_v15_source.get("result_id")
        or gate_v15.get("gate_a_status") != "FAIL_CLOSED"
        or gate_v15.get("accepted_top_level_hashes") != 1
        or gate_v15.get("remaining_top_level_hashes") != 6
        or gate_v15.get("full_source_q2_assembled") is not True
        or gate_v15.get("full_source_q3_assembled") is not True
    ):
        errors.append("strict Gate V15 projection")
