...
COMPLETION_ATLAS = ROOT / "foundations/results/FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V32.json"
...
COMPLETION_GATE_V14 = ROOT / "quantum-weyl/classical_import/certificates/CLASSICAL_IMPORT_GATE_V14_RECONCILIATION.json"
...
def check(data: dict[str, Any] | None = None) -> tuple[list[str], dict[str, Any]]:
    ...
    if completion.get("result_id") != "FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V32":
    ...
    if route_names[:3] != ["STRICT_AUXILIARY_Q3_COMMON_ASSEMBLY_AND_ARITY3_IDENTITIES", "STRICT_LAMBDA2_GENERAL_SOURCE_COCYCLE_CLOSURE", "STRICT_CANDIDATE_Q2_Q3_GREEN_LAMBDA2_RESPONSE"]:
        errors.append("strict V32 auxiliary-q3 route frontier")
    ...
    if (
        ...
        or source_q2.get("full_source_q3_assembled") is not False
        ...
        errors.append("strict V32 source-q2 assembly projection")
    gate_v14 = completion.get("strict_gate_v14_reconciliation", {})
    if (
        gate_v14.get("result_id") != gate_v14_source.get("result_id")
        or gate_v14.get("gate_a_status") != "FAIL_CLOSED"
        or gate_v14.get("accepted_top_level_hashes") != 1
        or gate_v14.get("full_source_q2_assembled") is not True
        or gate_v14.get("full_source_q3_assembled") is not False
    ):
        errors.append("strict Gate V14 projection")
    ...
    if result_flags.get("strict_386_first_nonlinear_equivalence_component_constructed") is not True or result_flags.get("strict_386_f_hat_v_v_pullback_channel_closed") is not True or result_flags.get("strict_386_full_source_q2_pullback_replayed") is not True or result_flags.get("strict_386_full_source_q3_pullback_replayed") is not False:
    ...
    if (
        ...
        errors.append("site V32 q2 identity exposure flags")
