...
COMPLETION_ATLAS = ROOT / "foundations/results/FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V23.json"
...
def check(data: dict[str, Any] | None = None) -> tuple[list[str], dict[str, Any]]:
    ...
    if completion.get("result_id") != "FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V23":
    ...
    if route_names[:3] != ["STRICT_AUTHORITATIVE_ARBITRARY_FULL_BV_Q2_Q3_EXPORT", "STRICT_ARITY_THREE_386_CYCLIC_STABILIZATION", "STRICT_LAMBDA2_GENERAL_SOURCE_COCYCLE_CLOSURE"]:
        errors.append("strict V23 q3 route frontier")
    if any(item in {"STRICT_TYPED_FIELD_EQUATION_GREEN_INVERSE", "STRICT_Q2_Q3_SOURCE_COCYCLE_CLOSURE", "STRICT_AUTHORITATIVE_Q2_Q3_ARITY_THREE_EXPORT", "STRICT_LAMBDA2_FULL_SOURCE_COCYCLE_CLOSURE"} for item in route_names):
        errors.append("strict V23 retired route frontier")
