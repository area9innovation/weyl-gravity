...
def verify(*, result=None, report=None) -> tuple[list[str], list[str]]:
    ...
    expected_summary = {
        ...
        "dual_direct_cells": 8,
        "mark_counts": {"G": 29, "Gl": 1, "L": 108, "LR": 8, "Lr": 6, "Ol": 172, "P": 19, "Pl": 79, "Plr": 13, "Pr": 51, "R": 87, "Rl": 3},
    }
