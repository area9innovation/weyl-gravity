...
def verify(*, result=None, report=None) -> tuple[list[str], list[str]]:
    ...
    expected_summary = {
        ...
        "dual_direct_cells": 8,
        "mark_counts": {"G": 29, "Gl": 1, "L": 110, "LR": 8, "Lr": 7, "Ol": 169, "P": 19, "Pl": 80, "Plr": 12, "Pr": 51, "R": 87, "Rl": 3},
    }
