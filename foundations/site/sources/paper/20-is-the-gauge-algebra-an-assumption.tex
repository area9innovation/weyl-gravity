...
The novelty claim of an earlier draft was wrong and was withdrawn once
\cite{BoulangerHenneaux2001} was found; that is recorded here rather than
quietly repaired.  What we searched for since: prior classification of the
gauge algebra of conformal gravity, prior enumeration of Noether identities of
the Bach tensor beyond transversality and tracelessness, and current work on
gauge structure and conserved currents in Weyl-squared gravity.  That last
turned up \cite{HobsonBarkerLasenby2026}, four days before this draft.  We did
not find a prior order-by-order search for further identities of the
\emph{nonlinear} action, which is a statement about our search and not a claim
about the literature.  Anyone who knows of one should regard this paper's
contribution as reduced accordingly.
