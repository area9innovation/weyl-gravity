  ...
  "completion_atlas": {
    ...
    "branches": [
      {
        ...
        "stages": [
          ...
          },
          {
            ...
            "status": "SCOPED_CERTIFIED",
            "statement": "The prolonged carrier has an all-row causal Green homotopy assembled from 356 algebraic and 30 causal endpoint rows.",
            "evidence": [
              "pure-weyl-full-prolonged-green-homotopy-assembly-v1"
            ],
            "boundary": "The theorem is architecture/background scoped and is not a Hadamard construction."
          },
          {
    ...
    "route_selection": [
      ...
      },
      {
        ...
        "tractability": "MEDIUM",
        "dependency_depth": "MEDIUM",
        "recommendation": "Test same-carrier nonlinear cyclic compatibility on the broadest curved causal strict branch."
      },
      {
        "rank": 5,
        "route": "GENERAL_NONCONE_104_COMPLETION",
        "branch": "BERGER_POSITIVE_CLOCK_54",
        "scientific_leverage": "HIGH",
    ...
    "research_queue": [
      ...
      },
      {
        ...
        "why": "It is the cleanest medium-tractability test of whether curved strict causal control survives nonlinear compatibility."
      },
      {
        "priority": 5,
        "branch": "BERGER_POSITIVE_CLOCK_54",
