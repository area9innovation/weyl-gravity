window.MATRIX_EXPLORER_DATA = {
  ...
  "completion_atlas": {
    ...
    "branches": [
      {
        ...
        "next_decisive_object": "Resolve the five-row ghost/identity suspension sign and serialize one canonical pairing on the exact 386-row carrier; extend it across the 356-row complement and independently replay the graded-adjoint Green identity. Then bind local D and q2 to those same bytes."
      },
      {
    ...
    "route_selection": [
      {
        "rank": 1,
        "route": "STRICT_386_PAIRING_SUSPENSION_BRIDGE",
        "branch": "STRICT_PURE_WEYL_386",
        "scientific_leverage": "VERY_HIGH",
        "tractability": "MEDIUM",
        "dependency_depth": "LOW",
        "recommendation": "Decide the five-row suspension convention and independently replay the exact graded-adjoint Green identity with one canonical pairing."
      },
      {
        "rank": 2,
        ...
        "recommendation": "Extend the selected pairing across the 356-row complement and serialize the background-specific local D on the same carrier."
      },
      {
        "rank": 3,
        ...
        "recommendation": "After the paired carrier and D bridge, test the target-action q2 against the same transported causal contraction."
      },
      {
        "rank": 4,
        ...
        "tractability": "LOW",
        "dependency_depth": "MEDIUM",
        "recommendation": "Retain the analytically mature parallel route through a direct nonstationary q26-equivariant distributional selection."
      },
      {
        "rank": 5,
        ...
        "tractability": "MEDIUM",
        "dependency_depth": "MEDIUM",
        "recommendation": "Use the broad curved strict causal branch as the independent nonlinear compatibility control."
      }
    ],
    "research_queue": [
      {
        "priority": 1,
        "branch": "STRICT_PURE_WEYL_386",
        "object": "five-row pairing/suspension bridge",
        "why": "The unary bytes now agree exactly; the remaining endpoint discrepancy is localized to the sign of the transported ghost/identity pairing."
      },
      {
        "priority": 2,
        "branch": "STRICT_PURE_WEYL_386",
        "object": "356-row complement pairing and local D",
        "why": "This is the smallest route from a common endpoint to one accepted full causal carrier."
      },
      {
        "priority": 3,
        "branch": "STRICT_PURE_WEYL_386",
        "object": "same-carrier q2/Green compatibility",
        "why": "It is the first nonlinear admission gate after the unary carrier is paired and D-equivariant."
      },
      {
        "priority": 4,
        "branch": "BERGER_POSITIVE_CLOCK_54",
        "object": "direct spacetime q26-equivariant nonstationary Hadamard selection",
        "why": "Berger remains the shortest independent route toward a full-carrier Hadamard/Ward result."
      },
      {
        "priority": 5,
        "branch": "PURE_WEYL_BACH_FLAT_RANK310",
    ...
    "independent_checker": {
      ...
      "checks": [
        "V4 preservation and scoped cell mutation",
        "seven-by-eleven stage closure",
        "80/80 unary table and 700/700 Bach-column projection",
        "common q1 digest",
        "five-row pairing sign firewall",
        "Gate-A and full-carrier firewalls",
        "unchanged Berger decision chain",
        "updated route ranking",
        "content hashes",
        "canonical digest"
      ],
      "expected_digest": "c3d9f41d0544bca7f2881f7fc86a53508126b115ab6bb7e1eb1eaa1bdffc1707"
    },
    ...
    "strict_gate_a_progress": {
      ...
      "remaining_common_carrier": "Choose and serialize one Gate-canonical suspension/pairing convention on the exact 386-row carrier, extend it across the 356-row complement, and independently replay the full Green graded-adjoint identity on those same bytes. Only then bind q2 and local D to the carrier and test nonlinear compatibility.",
  ...
  "source_links": {
    ...
    "completion_atlas": "sources/foundations/results/FOUNDATIONAL_LORENTZIAN_WEYL_BV_COMPLETION_ATLAS_V5.json",
    "completion_atlas_report": "sources/foundations/reports/lorentzian-weyl-bv-completion-atlas-v5.md",
  ...
  "canonical_digest": "734be93e1729498f573035121c7cea3b70197307bb4311c3d2698206c40a2e84"
};
