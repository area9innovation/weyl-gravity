...
transport, or prolonged current comparison.  The proposed all-row
prolongation currently has a rank-four final-square defect in the
fibre-identified Rees gate, so neither its support-local SDR nor its
prolonged BV differential is promoted.  This package also does not claim a
...
all-level spectrum are true.  The state/equation attachment square is exact,
but the current order-zero identity attachment leaves
`N0 A0-B0 C0` of rank four on the common Rees page.  Thus the abstract
mapping-cylinder and direct-sum-witness formulas remain conditional and do
not yet prove the complete all-row SDR, prolonged BV identity, or prolonged
current comparison.  After this attachment defect is repaired, closing the
witness will still require a
...
The remaining nine flags include repair of the all-row mapping cylinder and
current comparison as well as the prolonged Green witness, causal chain
...
four-jets.  The inferred sparse identity square, however, fails in the
fibre-identified coordinates with an exact rank-four defect.  Consequently
the common degree/sign-resolved odd BV mapping cylinder, nilpotent all-row
differential, support-local SDR, and prolonged current comparison remain
open.  A genuinely
...
audit are exact.  The all-row BV-canonical mapping cylinder still has the
rank-four identity-square defect.  The remaining work includes repairing
that attachment, then constructing the Green witness and homotopy, endpoint
