...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "the p=0,...,10 detector-prefactored polarization stream is certified through form two_j=138, but no full Green-weighted detector response is yet exported", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; all scalar rails p=0,2,...,28 are evaluated, while polarization composition for p=12,...,28 remains OPEN", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; all 15 external-clock scalar rails retain a(t)=cos(lambda s) without assuming clock/profile independence", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for the completed Green-weighted mode sum", "profile_green_boundary_dependencies": "validated clock moments and scalar streams now reach p=28; fixed degree ten is OBSTRUCTED as a uniform Green approximation, and p=12,...,28 polarization plus common order-14 charge-block application remain OPEN; the spatial tail and full Maxwell/massive images remain OPEN"},
