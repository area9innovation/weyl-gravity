...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "all detector-prefactored polarization inputs p=0,2,...,28 and their order-14 charge-block polynomial images are certified through form two_j=138, but temporal Green promotion is OBSTRUCTED", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; all 15 external-clock scalar and polarization rails are evaluated", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; all 15 rails retain a(t)=cos(lambda s) without assuming clock/profile independence", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for a certified full Green-weighted mode sum", "profile_green_boundary_dependencies": "the exact order-14 output stream contains 2,147,700 spatial and 717,255 temporal coefficient intervals; both geometric ratios contract, but the uniform bounds exceed one and exact extreme-block error lower bounds obstruct temporal Green promotion"},
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence", "high_order_moments", "scalar_stream", "scalar_s0", "scalar_s2", "scalar_s4", "scalar_s6", "scalar_s8", "scalar_s10", "polarization_stream", "temporal_order", "high_clock_p28", "adaptive_s12", "adaptive_s14", "adaptive_s16", "adaptive_s18", "adaptive_s20", "adaptive_s22", "adaptive_s24", "adaptive_s26", "adaptive_s28", "adaptive_polarization", "exact_charge_blocks", "order14_temporal"),
        },
        {
        ...
        },
        {
            ...
            "descriptions": {"causal": "OBSTRUCTED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the closure audit supplies no Green image or detector record", "response_rank": "OPEN", "emitter_preparation": "all 18 scalar recurrence inputs are now CERTIFIED; construct the 33 on-support real-form companions through p=28", "clock_and_rod_dependence": "exact D0/D1 support rules separate 27 structural zeros from 33 on-support companions in the selected radius-1/128 detector profile", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "closure input only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before charge-block completion and Green composition", "profile_green_boundary_dependencies": "direct temporal functional-calculus promotion from the 18 selected entries remains OBSTRUCTED: their 18 charge blocks contain 33 additional on-support real entries; all 18 scalar recurrence rows for those companions are now certified, but the form combinations and their clock rails remain OPEN; the spatial tail and all Green images remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("selected_clock_power_polarized", "selected_charge_block_closure", "selected_scalar_companion_completion"),
        },
        {
            ...
            "descriptions": {"causal": "CERTIFIED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: scalar input completion is not a detector response", "response_rank": "OPEN", "emitter_preparation": "construct the 33 on-support real-form companions and propagate their even clock powers through p=28", "clock_and_rod_dependence": "six new correlated scalar intervals use the radius-1/128 profile; indices 385,386 use 128 radial by 64 angular cells and the others 64x64", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "scalar input only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before form, charge-block and Green composition", "profile_green_boundary_dependencies": "all six formerly missing scalar rows and all 18 scalar inputs for the 33 form companions are CERTIFIED below width 0.1; the 33 form combinations, clock rails, temporal functional calculus, spatial tail and Green images remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("selected_charge_block_closure", "selected_scalar_companion_completion"),
        },
        {
