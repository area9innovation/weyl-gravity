...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence", "high_order_moments", "scalar_stream", "scalar_s0", "scalar_s2", "scalar_s4", "scalar_s6", "scalar_s8", "scalar_s10", "polarization_stream"),
        },
        {
