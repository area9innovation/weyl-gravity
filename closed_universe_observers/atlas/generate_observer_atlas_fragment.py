...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "the detector-prefactored polarization stream is certified through form two_j=138, but no full Green-weighted detector response is yet exported", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; the p=0,...,10 rails feed the certified polarization stream, while adaptive p=12,...,28 rails remain OPEN", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; detector coframe prefactors and the external a(t)=cos(lambda s) factor are applied without assuming clock/profile independence", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for the completed Green-weighted mode sum", "profile_green_boundary_dependencies": "86,736 detector-component entries and 520,416 clock-power intervals are reconstructible through form two_j=138; fixed degree ten is OBSTRUCTED as a uniform Green approximation, requiring common series order 14 and clock powers through p=28 before charge-block application; the spatial tail and full Maxwell/massive images remain OPEN"},
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence", "high_order_moments", "scalar_stream", "scalar_s0", "scalar_s2", "scalar_s4", "scalar_s6", "scalar_s8", "scalar_s10", "polarization_stream", "temporal_order"),
        },
        {
