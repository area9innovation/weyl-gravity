...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "evidence": _evidence("rank", "profiles", "form", "green_weighted", "recoil", "stress"),
        },
        {
            ...
            "evidence": _evidence("form", "green_weighted"),
        },
        {
