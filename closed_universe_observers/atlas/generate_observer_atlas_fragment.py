...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "streamed adaptive route selected; no full detector response evaluated", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; mode coefficients above two_j=4 OPEN", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; radial and clock-secant moments through k=50 are validated inputs", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for the completed mode sum", "profile_green_boundary_dependencies": "exact Clebsch--Gordan recurrences reduce the detector polarizations through two_j=138 to 57,824 supported coordinate entries and 154,012 neighboring scalar terms; validated radial and clock-secant moments now extend through k=50, while high-mode scalar values, truncation remainder, Green-weighted operator-norm tail, full Maxwell image and massive image remain OPEN"},
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence", "high_order_moments"),
        },
        {
