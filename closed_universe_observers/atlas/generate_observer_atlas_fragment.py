...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence"),
        },
        {
