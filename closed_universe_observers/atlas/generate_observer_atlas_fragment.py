...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "descriptions": {"causal": "OBSTRUCTED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the closure audit supplies no Green image or detector record", "response_rank": "OPEN", "emitter_preparation": "evaluate six scalar rows (1023;129,257,385) and (1025;130,258,386), then construct 33 on-support form companions through p=28", "clock_and_rod_dependence": "exact D0/D1 support rules separate 27 structural zeros from 33 on-support companions in the selected radius-1/128 detector profile", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "closure input only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before charge-block completion and Green composition", "profile_green_boundary_dependencies": "direct temporal functional-calculus promotion from the 18 selected entries is OBSTRUCTED: their 18 charge blocks contain 33 additional on-support real entries; those companions require 18 scalar recurrence rows, 12 certified and six missing; the spatial tail and all Green images remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("selected_clock_power_polarized", "selected_charge_block_closure"),
        },
        {
