...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "all detector-prefactored polarization inputs p=0,2,...,28 are certified through form two_j=138, but no full Green-weighted detector response is yet exported", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; all 15 external-clock scalar and polarization rails are evaluated", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; all 15 rails retain a(t)=cos(lambda s) without assuming clock/profile independence", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for the completed Green-weighted mode sum", "profile_green_boundary_dependencies": "the adaptive polarization successor adds 780,624 p=12,...,28 intervals with zero defects in 330 direct p=12 comparisons; common order-14 charge-block application and its remainder remain OPEN, followed by the spatial tail and full Maxwell/massive images"},
