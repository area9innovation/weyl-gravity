...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "descriptions": {"causal": "OBSTRUCTED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the current independent-moment scalar evaluator is numerically obstructed before a wider response rail can be selected", "response_rank": "OPEN", "emitter_preparation": "correlated oscillatory quadrature or stable recurrence selected for the next gate", "clock_and_rod_dependence": "external clock power p=0 and the fixed radius-1/128 profile; every certified two_j<=139 overlap must be preserved", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "absolute-g3 coefficient remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE at this coefficient-evaluator gate", "profile_green_boundary_dependencies": "two_j=140 raw width is below 0.001, but two_j=256 raw width exceeds 6e8; the exact unitary intersection is only [-1,1] and gives no decay; no validated Berger physical-space solver exists"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("high_mode_stability"),
        },
        {
