...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "operational_observable": {"detector_response": "streamed adaptive route selected; scalar inputs evaluated but no full Green-weighted detector response", "response_rank": "OPEN for the recoil-corrected response", "emitter_preparation": "existing detector-selected massive Cauchy pair; clock-integrated scalar coefficients now evaluated through two_j=139", "clock_and_rod_dependence": "radius-1/128 rod profile fixes the necessary two_j>=138 capacity rail; exact clock integration is included in all scalar stream intervals", "relational_redshift_contribution": "OPEN until the full same-background response is evaluated", "recoil_backreaction_order": "absolute g^3 operator exact; coefficient remains OPEN", "survives_gauge_reduction": "OPEN for the completed Green-weighted mode sum", "profile_green_boundary_dependencies": "all 9,870 diagonal scalar values through two_j=139 are reconstructible from 4,970 validated intervals with maximum binomial remainder below 10^-150; applying the polarization recurrence inside the temporal Green chain, the tail beyond two_j=138, full Maxwell image and massive image remain OPEN"},
            ...
            "evidence": _evidence("adaptive_route", "streaming_sectors", "polarization_recurrence", "high_order_moments", "scalar_stream"),
        },
        {
