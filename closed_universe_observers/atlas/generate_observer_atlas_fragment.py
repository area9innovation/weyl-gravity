...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "descriptions": {"causal": "OBSTRUCTED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the current independent-moment scalar evaluator is numerically obstructed; its central even p=0 correlated successor is now CERTIFIED but not yet generalized", "response_rank": "OPEN", "emitter_preparation": "generalize the certified central Legendre reduction to every diagonal and clock power", "clock_and_rod_dependence": "external clock power p=0 and the fixed radius-1/128 profile; every certified central even overlap is preserved", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "absolute-g3 coefficient remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE at this coefficient-evaluator gate", "profile_green_boundary_dependencies": "the obsolete raw two_j=256 width exceeds 6e8; the correlated central successor reduces it below 0.001 and remains below width 0.1 through two_j=2048; noncentral and p>0 channels remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("high_mode_stability", "central_scalar_evaluator"),
        },
        {
            ...
            "descriptions": {"causal": "CERTIFIED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "central even p=0 scalar input rail CERTIFIED; full polarized detector response remains OPEN", "response_rank": "OPEN", "emitter_preparation": "general stable Jacobi recurrence for noncentral, odd and p=2,...,28 channels remains the next gate", "clock_and_rod_dependence": "exact radius-1/128 support, normalized clock p=0 factor and exact angular average", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "input evaluator only; recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE at this scalar coefficient gate", "profile_green_boundary_dependencies": "exact D^(j)_(0,0)=P_j(1-2 y_perp^2); all 70 central even overlaps through two_j=138 pass, two_j=256 width is below 0.001, and the scoped rail remains below width 0.1 through two_j=2048"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
...
OBSERVER_STATUSES = {
    ...
    "observer.berger.detector_profile.correlated_central_scalar": ["CERTIFIED", "OPEN", "OPEN", "CERTIFIED", "NOT_APPLICABLE", "OPEN", "NOT_APPLICABLE", "CERTIFIED", "NOT_APPLICABLE", "NOT_APPLICABLE", "NOT_APPLICABLE", "NOT_APPLICABLE", "NOT_APPLICABLE"],
