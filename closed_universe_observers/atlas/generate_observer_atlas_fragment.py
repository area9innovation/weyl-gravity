...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "descriptions": {"causal": "CERTIFIED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the recurrence-closed scalar inputs are CERTIFIED, and their selected p=0 polarized successor is separately CERTIFIED; no Green image or detector response is composed", "response_rank": "OPEN", "emitter_preparation": "the 18 selected p=0 polarized entries are now evaluated; add external clock powers p=2,...,28", "clock_and_rod_dependence": "radius-1/128 detector bump and normalized p=0 clock envelope; high-fraction scalar companions use radial-only 128x64 refinement", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "input closure only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before polarized coderivative and Green composition", "profile_green_boundary_dependencies": "the exact form-two_j=1024 recurrence requires 12 scalar rows on shells 1023,1025; three are imported and nine newly evaluated, all below width 0.1; a same-index-only mutation omits six r-1/r+1 neighbors; the selected p=0 polarized combinations are separate, while higher clock powers and all tails remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("adaptive_fraction_scale", "polarization_scalar_closure", "selected_p0_polarized"),
        },
        {
            ...
            "descriptions": {"causal": "CERTIFIED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: 18 selected high-scale polarized input intervals are CERTIFIED, but no Maxwell/massive Green image or detector response is composed", "response_rank": "OPEN", "emitter_preparation": "evaluate the recurrence-closed scalar inputs and selected polarized entries for external clock powers p=2,...,28", "clock_and_rod_dependence": "radius-1/128 detector bump, normalized p=0 clock envelope and exact D0/D1 coframe prefactors", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "selected polarized input only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before the full coderivative and Green-weighted sum", "profile_green_boundary_dependencies": "all 18 p=0 form intervals and 54 scalar-term applications are content-addressed; every maximum real/imaginary width is below 0.1, with the maximum below 0.099; higher clock powers, complete form coverage and all tails remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("polarization_scalar_closure", "selected_p0_polarized"),
        },
        {
