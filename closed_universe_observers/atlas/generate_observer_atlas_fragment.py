...
def entries() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "descriptions": {"causal": "OBSTRUCTED", "symplectic": "NOT_APPLICABLE", "nonlinear": "NOT_APPLICABLE", "observational": "OPEN", "quantum": "NOT_APPLICABLE"},
            "operational_observable": {"detector_response": "OPEN: the temporal input route is obstructed before any detector record is composed", "response_rank": "OPEN", "emitter_preparation": "certify a correlated direct normalized clock-microphase transform in the exact selected-block spectral projectors, with lower-band overlap", "clock_and_rod_dependence": "the lower-band order-14 theorem ends at two_j=138; all nine selected two_j=1024 charges have positive exact order-14 cosine-error witnesses, and all 18 independent-interval outputs exceed width 0.1", "relational_redshift_contribution": "NOT_APPLICABLE", "recoil_backreaction_order": "temporal bandwidth preflight only; absolute-g3 recoil remains OPEN", "survives_gauge_reduction": "NOT_APPLICABLE before a certified temporal image, controlled tail and Green composition", "profile_green_boundary_dependencies": "the current geometric proof needs orders through 39 and p=78, but appending monomials cannot narrow the current independent-interval class; order-14/p28 promotion is OBSTRUCTED, while the exact correlated transform, spatial tail and Green images remain OPEN"},
            "tangent_cone": {"restriction_status": "NOT_APPLICABLE", "linearly_detectable_but_nonlinearly_obstructed": "NOT_APPLICABLE", "balanced_detectable_combinations": "NOT_APPLICABLE", "observer_source_channel": "NOT_APPLICABLE", "correction_classes": {"bounded_or_quasiperiodic": "NOT_APPLICABLE", "smooth_secular": "NOT_APPLICABLE", "causal_or_retarded": "NOT_APPLICABLE"}},
            "evidence": _evidence("selected_form_companion_clock_rail", "blockwise_temporal_preflight", "blockwise_temporal_stream", "selected_temporal_bandwidth_preflight"),
        },
        {
