...
SOURCES = {
    ...
    "dressed_rod_clock": P / "certificates/BERGER_108_ROW_DRESSED_ROD_CLOCK_Q2_PBW_PAYLOAD.json",
...
def payload_document() -> dict[str, Any]:
    ...
    return {
        ...
        "composition": "source-labelled additive sum of the separate gravity-clock q2 payload, typed Maxwell q2 overlay, the action-derived dressed-rod clock correction, and six apparatus/emitter tensors after zero-extension to 108 rows; shared operator keys retain every coefficient monomial",
