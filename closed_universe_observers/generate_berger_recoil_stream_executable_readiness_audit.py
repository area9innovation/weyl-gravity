...
def build() -> dict[str, Any]:
    ...
    boundary = (
        ...
        "callables. The exact co-closed canonical trace and coupling-stripped positive-energy dual "
        "are also bound to finite preparation coefficients; free emitter evolution and the first retarded channel are not yet bound, "
