...
python3 -m closed_universe_observers.generate_berger_108_row_complete_q2_pbw --check
python3 -m closed_universe_observers.verify_berger_108_row_complete_q2_pbw
python3 -m closed_universe_observers.generate_berger_108_row_arity_two_obstruction --check
...
python3 -m closed_universe_observers.generate_berger_clock_uniform_profile_sobolev_n1 --check
python3 -m closed_universe_observers.verify_berger_clock_uniform_profile_sobolev_n1
python3 -m closed_universe_observers.generate_berger_correlated_profile_sobolev_n1 --check
python3 -m closed_universe_observers.verify_berger_correlated_profile_sobolev_n1
