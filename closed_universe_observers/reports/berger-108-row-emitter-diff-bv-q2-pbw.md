# Berger 108-row emitter Diff--BV q2 PBW block

This artifact expands the two massive-emitter vertices
`<K_b_plus,L_c K_b>` in the non-holonomic Berger frame.  The direct
two-form component formula agrees termwise with the independent Cartan
...
`q2`; assembly of one complete 108-row `q2` payload remains the next gate.
