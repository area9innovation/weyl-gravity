...
Quantum:     keep reduced vacuum-cylinder Bridge 4 scoped to its Krein carrier; compute the independent cubic Weyl-invariant and nonlocal R2 form factors plus finite C2/absolute dressed R(g_hat)^2 normalization, then import a same-background compensator contraction before residual Q1 transfer
...
normalization, independent nonlocal `R2` form factor, independent cubic-and-higher Weyl-invariant form factors, Paneitz/FV kernel and global data, and
