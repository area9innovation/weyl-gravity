...
interpolation and five-carrier projection of the physical three-linear common
numerator and import of the curvature-squared Hessian layer. The same-gauge
`H1` rows, their exact formal-adjoint rank-nine momentum vertex and one
nonzero generic interior simplex fixture are already certified. The selected generic weight-raised
