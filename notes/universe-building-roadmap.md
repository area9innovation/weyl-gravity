...
| Paper 12, pure-Weyl one-loop BV anomaly/QME | `DRAFT_ALLOWED`; theorem-spine manuscript, compiled PDF, and fail-closed claim map assembled for the strict obstruction and tau-adic extended one-loop local Euclidean restoration | complete specialist literature/prose review and supplement audit; the next theorem requires an extended classical contraction, coefficient-bearing `Q1`, and quantum `D`-defect disposition; Lorentzian/state claims remain separate |
