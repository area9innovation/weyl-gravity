...
`(-1/3,1/9,-1/81)`. Its generic relative determinant and possible local zeta
multiplicative term remain unevaluated. Those data, simplex-integrated
...
The next coefficient-bearing analytic gate is evaluation of the normalized
longitudinal Schur relative determinant, its possible local zeta term, and
the physical fourth-order Hessian kernel. The exact Endo--Duhamel,
