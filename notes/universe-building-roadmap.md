...
rational combinations of `4 Cl2(pi/3)/sqrt(3)`; generic kinematic functions
remain open. Exact Hodge-resolvent
...
carrier data, generic-kinematic repository functions and coefficients beyond
the symmetric fixture, and the parity-odd derivative
