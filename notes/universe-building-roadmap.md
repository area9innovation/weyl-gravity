...
`H2` cancellation is therefore refuted on this fixture. The `M14` disposition
now requires a local covariant subtraction/distribution extension and
renormalized mixed-row assembly. The selected generic weight-raised
