...
generic integration of the exact physical three-linear five-carrier rows and
import of the curvature-squared Hessian layer. The same-gauge `H1` rows,
...
certified. The selected generic weight-raised
