...
gauge-ordering commutator crosswalk, and round split `24-16=8`; the mixed
`H1-H2` completion must be tested against that class, or an explicit
subtraction fixed. The selected generic weight-raised
