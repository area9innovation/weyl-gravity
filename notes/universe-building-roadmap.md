...
3. Define the first observer morphism from global observables to the two
   ...
   exact q2 regression and cyclic completion.  The base
   gravity-clock-Maxwell and physical-emitter `q3` sources remain to assemble;
   scalar-BV and emitter Diff--BV are
