...
Observer:    await and independently verify an explicit provenance-complete physical declaration under the certified v2 recoil contract; in parallel use the certified nonlinear clock second jet and passing mixed epsilon_R_squared*kappa unary gate to export scalar apparatus q2,q3, test K_Berger equivariance and observer-morphism stability, then restrict records to Z2^C
