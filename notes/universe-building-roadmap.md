...
all-Hodge audit is now active.  Nonlinear,
...
```text
Einstein:    the selected counterflow Berger point fails common Einstein-matter/Weyl-matter background incidence, so return to the compact-product bridge and complete the direct four-dimensional polar Lee-Wald current before the ungauged residual descent
...
Classical:   the unrestricted zero-Jordan drift is now an exact positive action-angle family tangent, but the complete background is isolated; run the all-Hodge health census now, then return to the missing spatial lifts and charge-typed receiver
