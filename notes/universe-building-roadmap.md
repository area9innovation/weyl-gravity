...
```text
Einstein:    the first asymptotic Bach raw-current gate is now exactly obstructed: retaining p=0 boundary-metric data gives a linear cut divergence, while fixing p=0 makes the p=1 carrier radical; derive a covariant tensor Bondi Lee--Wald counterterm and i0/I+ corner prescription before P0 or D_M charges, and retain H_ESU as non-boundary-preserving on the fixed patch and D_rad as NO_CERTIFIED_MAP
