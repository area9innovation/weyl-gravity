...
Black hole:  causal disposition of the extra branch (horizon flux matrix closed at fixture level: cross and extra blocks nonzero)
```
...
are exact digamma/trigamma values; a finite-rank smoothing witness proves
that their generic versions require a full primed Green/spectral carrier.
The possible local zeta multiplicative term remains unevaluated. Those data, simplex-integrated
...
spectral carrier lifting the exact round-`S4` finite rows, any local zeta
term, and the physical fourth-order Hessian kernel. The canonical
