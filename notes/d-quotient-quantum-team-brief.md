...
absent. Complete `Gamma1` and `Q1` therefore remain fail-closed,
...
Weyl-invariant finite `Gamma1` normalization and complete `Q1`; its independent
carrier gate is Bridge 2. The generated fail-closed row is
