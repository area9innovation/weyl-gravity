...
`observer.berger.interaction.rod_metric_q2_pbw` and
`observer.berger.interaction.memory_transport_q2_pbw`: those three apparatus
`q2` subblocks are `CERTIFIED`, while complete apparatus `q2`, all `q3`,
detector response and cone restriction remain
...
generated by exact integration by parts.  Normalized readout and emitter
`q2` sectors, every `q3`, the arity identities,
`K_Berger` equivariance, observer-morphism stability and
