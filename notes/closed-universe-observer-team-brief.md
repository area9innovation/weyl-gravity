...
`F_ij=e_i A_j-e_j A_i-C^k_ij A_k`.  Only the six rod gauge/wave sectors,
gravity--rod Hessian and shifted `q2(Phi2,-)` block remain before full
composition and replay.  The 618 terms live in a compact, schema-validated,
