...
def validate_export(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    for generator in generators:
        ...
        for row_name, row in decomposition.items():
            ...
            if row_name == "Q_gt0" and row["antifield_number_shift"] < 1:
                raise AntifieldExportError(f"{symbol}: Q_gt0 must have positive filtration degree")
...
def main() -> int:
    ...
    try:
        result = validate_export(_load(args.export))
