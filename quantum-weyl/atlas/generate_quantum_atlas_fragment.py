...
def _berger_gap(values: dict[str, dict[str, Any]]) -> dict[str, Any]:
    return _entry(
        ...
        _quantum_data(
            ...
            hadamard=("OPEN", "finite graph wavefront safety, local ghost factors, the smooth cutoff Green family, its factorwise-null Pauli-Jordan kernel, a regular internal time-slice source map, a metric-sector RFHGHO dilation, two regular Cauchy morphism legs and orientation of every finite same-sided Volterra term are certified; convergence in the fixed D'_Gamma normal topology, hence infinite-series same-orientation exclusion and morphism cone mapping, plus a free seed covariance, restriction to the full graded BV carrier and BRST Ward identities remain open"),
