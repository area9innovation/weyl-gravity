...
def _guard_entries(values: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
    specs = [
        ...
        ("product_s2_s2_schur_spectral_carrier", "non-Einstein S2(k1)xS2(k2) scalar-exact ghost spectral carrier with exact anisotropic Schur eigenvalues and matched vector-zero/Schur-pole correction 3^-6; bivariate infinite sums open; special-background non-particle carrier", ["LOCAL-ALGEBRAIC", "EUCLIDEAN-SPECTRAL"], ("product_S2_S2_ghost_Schur_spectral_carrier",)),
