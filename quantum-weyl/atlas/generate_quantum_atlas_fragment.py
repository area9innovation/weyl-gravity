...
def _berger_gap(values: dict[str, dict[str, Any]]) -> dict[str, Any]:
    return _entry(
        ...
        _quantum_data(
            ...
            hadamard=("OPEN", "finite graph wavefront safety, local ghost factors, the smooth cutoff Green family, its factorwise-null Pauli-Jordan kernel, a regular internal time-slice source map, a metric-sector RFHGHO dilation and two regular Cauchy morphism legs are certified; morphism cone mapping, same-orientation exclusion, a free seed covariance, restriction to the full graded BV carrier and BRST Ward identities remain open"),
        ...
        _evidence(values, "Berger_causal_chain", "Berger_Hadamard_gate", "Berger_Hadamard_regular_morphism_boundary", "Berger_temporal_cutoff_Green_family", "Berger_cutoff_microlocal_response", "Berger_cutoff_Hermitian_dilation", "Berger_A104_complete", "Berger_graph_q_obstruction", "Slavnov_preflight", "regulated_Slavnov_breaking"),
        "The 26/54-row causal carrier and all 10,816 coefficients of A104 are imported. Finite graph wavefront safety, local ghost factors, the cutoff Green family, factorwise-null Pauli-Jordan control, a regular internal time-slice source map, a metric-sector RFHGHO dilation and two regular endpoint morphism legs are certified. Their cone action, same-orientation exclusion, a free seed covariance and restriction to the full graded BV carrier remain absent. The tautological stationary q_Cauchy graph lift is independently rejected by 157 square and 207 evolution-commutator defects. No physical mode, complex structure, Hadamard state, or particle is inferred.",
    )
