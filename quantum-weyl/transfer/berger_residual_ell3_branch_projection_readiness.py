...
def build() -> dict[str, object]:
    ...
    return {
        ...
        "claim_boundary": (
            ...
            "is not admitted as a third particle or dynamical branch. Every mixing entry must be "
            "computed from the accepted tensor and every claimed zero must carry an exact witness. No branch "
