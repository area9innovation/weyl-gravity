...
from local_bv.six_derivative_certificate import (
    DETAILED_PATH,
    RESULT_PATH,
    SCHEMA_PATH,
    build_certificate,
...
class SixDerivativeCertificateTests(unittest.TestCase):
    ...
    def test_detailed_certificate_satisfies_enforced_schema(self) -> None:
        ...
        certificate["combined"]["quotient_dimension"] = 9
        self.assertIn(
            "$.combined.quotient_dimension: value differs from const",
