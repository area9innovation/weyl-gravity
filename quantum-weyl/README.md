...
| F | one-loop Slavnov breaking and QME status | `ASSEMBLY_AND_MULTIPLICITY_RECEIVERS_READY_ANALYTIC_MATCHING_OPEN`; the exact quotient reduction and strict analytic exports are ready, but the repository full-BV multiplicity ledger, regulated breaking, and QME disposition are `NOT_COMPUTED` |
