...
- [`reports/generic-background-ghost-schur-schatten-split.md`](reports/generic-background-ghost-schur-schatten-split.md)
  ...
  modified Fredholm tail, and computes the critical local `Wres(K^2)`
  coefficient while retaining the two regulated trace rows.
