...
| D | reduced and Euclidean coefficient ledgers | `STANDARD_BACKGROUND_VECTOR_BOUND_REPOSITORY_MATCHING_OPEN`; the exact standard even vector `(199/30,-87/20)` is reduced against the complete gauge-fixed BV quotient, while the parity-odd coordinate and repository regulator/measure match remain uncomputed |
