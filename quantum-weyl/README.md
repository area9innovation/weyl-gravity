...
- [`reports/generic-background-ghost-n3-pole3-relative-ibp.md`](reports/generic-background-ghost-n3-pole3-relative-ibp.md)
  ...
  normalized dual witnesses that punctured-corner logarithms cannot all be
  removed; their bubble-log conversion and the pole-four `I29` row remain open.
