...
- [`reports/generic-background-ghost-n3-barycentric-factorization.md`](reports/generic-background-ghost-n3-barycentric-factorization.md)
  ...
  `I28` relation, while leaving the relative-IBP/bubble reduction open.
