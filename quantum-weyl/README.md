...
| B | counterterm/anomaly bases and descent database | `IN_PROGRESS`; exact quadratic and once-differentiated curvature/Bianchi, commutator, IBP, parity, and Hodge infrastructure, but no cohomology classification |
