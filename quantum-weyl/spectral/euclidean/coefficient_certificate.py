    ...
    payload = {
        ...
        **calculation,
        "analytic_inputs": {
            ...
            "repository_euclidean_gate": "PRECERTIFICATE_STANDARD_BACKGROUND_RESULT_CLASSICAL_FREEZE_AND_AUXILIARY_EQUIVALENCE_OPEN",
        },
        "source_provenance": {
            "primary_source": {
        ...
        "claim_boundary": (
            ...
            "the factorized conformal-spin-two determinant and heat-kernel formulae. They are not yet matched to the "
            "repository's unfrozen full BV field/antifield measure and do not compute the quantum-master-equation "
            "breaking. The D result is only the one-generator pullback of the local ghost-number-one cocycle. Its "
